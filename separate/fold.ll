...
@longopts = internal constant [6 x %struct.option] [%struct.option { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.30, i32 0, i32 0), i32 0, i32* null, i32 98 }, %struct.option { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.31, i32 0, i32 0), i32 0, i32* null, i32 115 }, %struct.option { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.32, i32 0, i32 0), i32 1, i32* null, i32 119 }, %struct.option { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.33, i32 0, i32 0), i32 0, i32* null, i32 -130 }, %struct.option { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.34, i32 0, i32 0), i32 0, i32* null, i32 -131 }, %struct.option zeroinitializer], align 16
@optarg = external dso_local global i8*, align 8
@.str.8 = private unnamed_addr constant [26 x i8] c"invalid number of columns\00", align 1
...
@.str.31 = private unnamed_addr constant [7 x i8] c"spaces\00", align 1
@.str.32 = private unnamed_addr constant [6 x i8] c"width\00", align 1
...
if.else:                                          ; preds = %entry
  ...
  %call3 = call i32 @fputs_unlocked(i8* getelementptr inbounds ([147 x i8], [147 x i8]* @.str.3, i64 0, i64 0), %struct._IO_FILE* %5)
...
entry:
  ...
  %call = call i32 @fputs_unlocked(i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str.12, i64 0, i64 0), %struct._IO_FILE* %0)
  ret void
}
...
entry:
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call = call i32 @fputs_unlocked(i8* getelementptr inbounds ([75 x i8], [75 x i8]* @.str.13, i64 0, i64 0), %struct._IO_FILE* %0)
  ret void
}
...
if.end:                                           ; preds = %if.then, %while.end
  %call6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.23, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.9, i64 0, i64 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.24, i64 0, i64 0))
...
if.end13:                                         ; preds = %if.then11, %land.lhs.true, %if.end
  ...
  %cond = select i1 %cmp15, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.29, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.7, i64 0, i64 0)
...
while.cond:                                       ; preds = %sw.epilog, %entry
  ...
  %call2 = call i32 @getopt_long(i32 %2, i8** %3, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @shortopts, i64 0, i64 0), %struct.option* getelementptr inbounds ([6 x %struct.option], [6 x %struct.option]* @longopts, i64 0, i64 0), i32* null) #10
...
sw.bb7:                                           ; preds = %while.body, %if.end
  %8 = load i8*, i8** @optarg, align 8
  %call8 = call i64 @xdectoumax(i8* %8, i64 1, i64 -10, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.7, i64 0, i64 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.8, i64 0, i64 0), i32 0)
...
sw.bb10:                                          ; preds = %while.body
  ...
  call void (%struct._IO_FILE*, i8*, i8*, i8*, ...) @version_etc(%struct._IO_FILE* %9, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.9, i64 0, i64 0), i8* %10, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.10, i64 0, i64 0), i8* null)
...
if.then13:                                        ; preds = %while.end
  ...
  %call14 = call zeroext i1 @fold_file(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i64 0, i64 0), i64 %13)
...
if.then31:                                        ; preds = %land.lhs.true
  %call32 = call i32* @__errno_location() #15
  %25 = load i32, i32* %call32, align 4
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %25, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i64 0, i64 0))
  unreachable
...
; Function Attrs: noinline nounwind uwtable
define internal zeroext i1 @fold_file(i8* %filename, i64 %width) #2 {
entry:
  ...
  %call = call i32 @strcmp(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i64 0, i64 0)) #13
  %cmp = icmp eq i32 %call, 0
  br i1 %cmp, label %if.then, label %if.else
...
if.else:                                          ; preds = %entry
  ...
  %call1 = call %struct._IO_FILE* @fopen(i8* %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.35, i64 0, i64 0))
...
while.cond:                                       ; preds = %if.end58, %if.then50, %if.then14, %if.end6
  ...
  %call7 = call i32 @getc_unlocked(%struct._IO_FILE* %7)
...
if.then14:                                        ; preds = %if.end12
  ...
  %call15 = call i64 @fwrite_unlocked(i8* %15, i64 1, i64 %16, %struct._IO_FILE* %17)
  store i64 0, i64* %offset_out, align 8
  store i64 0, i64* %column, align 8
  br label %while.cond
...
rescan:                                           ; preds = %if.end54, %for.end, %if.end16
...
while.cond23:                                     ; preds = %if.end34, %if.then22
...
while.body25:                                     ; preds = %while.cond23
  ...
  %call26 = call i16** @__ctype_b_loc() #15
...
if.then36:                                        ; preds = %while.end
  ...
  %call38 = call i64 @fwrite_unlocked(i8* %33, i64 1, i64 %34, %struct._IO_FILE* %35)
  ...
  %sub = sub i64 %39, %40
  call void @llvm.memmove.p0i8.p0i8.i64(i8* align 1 %36, i8* align 1 %add.ptr, i64 %sub, i1 false)
  %41 = load i64, i64* %logical_end, align 8
  %42 = load i64, i64* %offset_out, align 8
  %sub40 = sub i64 %42, %41
...
for.cond:                                         ; preds = %for.inc, %if.then36
  ...
  %44 = load i64, i64* %offset_out, align 8
  %cmp41 = icmp ult i64 %43, %44
  br i1 %cmp41, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %45 = load i64, i64* %column, align 8
  %46 = load i8*, i8** @fold_file.line_out, align 8
  %47 = load i64, i64* %i, align 8
  %arrayidx43 = getelementptr inbounds i8, i8* %46, i64 %47
  %48 = load i8, i8* %arrayidx43, align 1
  %call44 = call i64 @adjust_column(i64 %45, i8 signext %48)
...
if.end47:                                         ; preds = %if.end46, %if.then21
  %50 = load i64, i64* %offset_out, align 8
  %cmp48 = icmp eq i64 %50, 0
  br i1 %cmp48, label %if.then50, label %if.end54

if.then50:                                        ; preds = %if.end47
  %51 = load i32, i32* %c, align 4
  %conv51 = trunc i32 %51 to i8
  %52 = load i8*, i8** @fold_file.line_out, align 8
  %53 = load i64, i64* %offset_out, align 8
  %inc52 = add i64 %53, 1
  store i64 %inc52, i64* %offset_out, align 8
  %arrayidx53 = getelementptr inbounds i8, i8* %52, i64 %53
  store i8 %conv51, i8* %arrayidx53, align 1
  br label %while.cond

if.end54:                                         ; preds = %if.end47
  %54 = load i8*, i8** @fold_file.line_out, align 8
  %55 = load i64, i64* %offset_out, align 8
  %inc55 = add i64 %55, 1
  store i64 %inc55, i64* %offset_out, align 8
  %arrayidx56 = getelementptr inbounds i8, i8* %54, i64 %55
  store i8 10, i8* %arrayidx56, align 1
  %56 = load i8*, i8** @fold_file.line_out, align 8
  %57 = load i64, i64* %offset_out, align 8
  %58 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call57 = call i64 @fwrite_unlocked(i8* %56, i64 1, i64 %57, %struct._IO_FILE* %58)
  store i64 0, i64* %offset_out, align 8
  store i64 0, i64* %column, align 8
  br label %rescan
...
if.end58:                                         ; preds = %rescan
  ...
  %conv59 = trunc i32 %59 to i8
  %60 = load i8*, i8** @fold_file.line_out, align 8
  %61 = load i64, i64* %offset_out, align 8
  %inc60 = add i64 %61, 1
  store i64 %inc60, i64* %offset_out, align 8
  %arrayidx61 = getelementptr inbounds i8, i8* %60, i64 %61
  store i8 %conv59, i8* %arrayidx61, align 1
  br label %while.cond

while.end62:                                      ; preds = %while.cond
  %call63 = call i32* @__errno_location() #15
  %62 = load i32, i32* %call63, align 4
  store i32 %62, i32* %saved_errno, align 4
  %63 = load i64, i64* %offset_out, align 8
  %tobool64 = icmp ne i64 %63, 0
  br i1 %tobool64, label %if.then65, label %if.end67

if.then65:                                        ; preds = %while.end62
  %64 = load i8*, i8** @fold_file.line_out, align 8
  %65 = load i64, i64* %offset_out, align 8
  %66 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call66 = call i64 @fwrite_unlocked(i8* %64, i64 1, i64 %65, %struct._IO_FILE* %66)
  br label %if.end67

if.end67:                                         ; preds = %if.then65, %while.end62
  %67 = load %struct._IO_FILE*, %struct._IO_FILE** %istream, align 8
  %call68 = call i32 @ferror_unlocked(%struct._IO_FILE* %67) #10
...
if.then70:                                        ; preds = %if.end67
  ...
  %call71 = call i8* @quotearg_n_style_colon(i32 0, i32 3, i8* %69)
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %68, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.36, i64 0, i64 0), i8* %call71)
  %70 = load i8*, i8** %filename.addr, align 8
  %call72 = call i32 @strcmp(i8* %70, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i64 0, i64 0)) #13
  %cmp73 = icmp eq i32 %call72, 0
  br i1 %cmp73, label %if.end77, label %if.then75

if.then75:                                        ; preds = %if.then70
  %71 = load %struct._IO_FILE*, %struct._IO_FILE** %istream, align 8
  %call76 = call i32 @rpl_fclose(%struct._IO_FILE* %71)
  br label %if.end77
...
if.end78:                                         ; preds = %if.end67
  %72 = load i8*, i8** %filename.addr, align 8
  %call79 = call i32 @strcmp(i8* %72, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i64 0, i64 0)) #13
  %cmp80 = icmp eq i32 %call79, 0
  br i1 %cmp80, label %if.end88, label %land.lhs.true

land.lhs.true:                                    ; preds = %if.end78
  %73 = load %struct._IO_FILE*, %struct._IO_FILE** %istream, align 8
  %call82 = call i32 @rpl_fclose(%struct._IO_FILE* %73)
  %cmp83 = icmp eq i32 %call82, -1
  br i1 %cmp83, label %if.then85, label %if.end88

if.then85:                                        ; preds = %land.lhs.true
  %call86 = call i32* @__errno_location() #15
  %74 = load i32, i32* %call86, align 4
  %75 = load i8*, i8** %filename.addr, align 8
  %call87 = call i8* @quotearg_n_style_colon(i32 0, i32 3, i8* %75)
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %74, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.36, i64 0, i64 0), i8* %call87)
  store i1 false, i1* %retval, align 1
  br label %return
...
; Function Attrs: noinline nounwind uwtable
define internal i64 @adjust_column(i64 %column, i8 signext %c) #2 {
entry:
...
if.end21:                                         ; preds = %if.else19, %if.end18
  %10 = load i64, i64* %column.addr, align 8
  ret i64 %10
}
...
if.else:                                          ; preds = %if.then
  ...
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %7, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2.42, i64 0, i64 0), i8* %8)
  br label %if.end
...
if.then:                                          ; preds = %entry
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %call = call i32 @fputs(i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str.51, i64 0, i64 0), %struct._IO_FILE* %1)
  call void @abort() #12
  unreachable
...
land.lhs.true:                                    ; preds = %cond.end
  ...
  %call5 = call i32 @strncmp(i8* %add.ptr4, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1.52, i64 0, i64 0), i64 7) #13
...
if.then7:                                         ; preds = %land.lhs.true
  ...
  %call8 = call i32 @strncmp(i8* %10, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2.53, i64 0, i64 0), i64 3) #13
...
if.end:                                           ; preds = %entry
  ...
  %call1 = call i32 @c_strcasecmp(i8* %4, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.13.67, i64 0, i64 0)) #13
...
if.end6:                                          ; preds = %if.end
  ...
  %call7 = call i32 @c_strcasecmp(i8* %8, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.16.70, i64 0, i64 0)) #13
...
if.then:                                          ; preds = %entry
  ...
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.77, i64 0, i64 0), i8* %2, i8* %3, i8* %4)
  br label %if.end
...
if.else:                                          ; preds = %entry
  ...
  %call1 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1.78, i64 0, i64 0), i8* %6, i8* %7)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %8, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @version_etc_copyright, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2.79, i64 0, i64 0), i32 2020)
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call3 = call i32 @fputs_unlocked(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3.80, i64 0, i64 0), %struct._IO_FILE* %9)
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call4 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %10, i8* getelementptr inbounds ([171 x i8], [171 x i8]* @.str.4.81, i64 0, i64 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.5.82, i64 0, i64 0))
  %11 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call5 = call i32 @fputs_unlocked(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3.80, i64 0, i64 0), %struct._IO_FILE* %11)
...
sw.bb6:                                           ; preds = %if.end
  ...
  %call7 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %13, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.6.83, i64 0, i64 0), i8* %15)
  br label %sw.epilog
...
sw.bb8:                                           ; preds = %if.end
  ...
  %call11 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %16, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7.84, i64 0, i64 0), i8* %18, i8* %20)
  br label %sw.epilog
...
sw.bb12:                                          ; preds = %if.end
  ...
  %call16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %21, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.8.85, i64 0, i64 0), i8* %23, i8* %25, i8* %27)
  br label %sw.epilog
...
sw.bb17:                                          ; preds = %if.end
  ...
  %call22 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %28, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.9.86, i64 0, i64 0), i8* %30, i8* %32, i8* %34, i8* %36)
  br label %sw.epilog
...
sw.bb23:                                          ; preds = %if.end
  ...
  %call29 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %37, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.10.87, i64 0, i64 0), i8* %39, i8* %41, i8* %43, i8* %45, i8* %47)
  br label %sw.epilog
...
sw.bb30:                                          ; preds = %if.end
  ...
  %call37 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.11.88, i64 0, i64 0), i8* %50, i8* %52, i8* %54, i8* %56, i8* %58, i8* %60)
  br label %sw.epilog
...
sw.bb38:                                          ; preds = %if.end
  ...
  %call46 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %61, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.12.89, i64 0, i64 0), i8* %63, i8* %65, i8* %67, i8* %69, i8* %71, i8* %73, i8* %75)
  br label %sw.epilog
...
sw.bb47:                                          ; preds = %if.end
  ...
  %call56 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %76, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.13.90, i64 0, i64 0), i8* %78, i8* %80, i8* %82, i8* %84, i8* %86, i8* %88, i8* %90, i8* %92)
  br label %sw.epilog
...
sw.bb57:                                          ; preds = %if.end
  ...
  %call67 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %93, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.14.91, i64 0, i64 0), i8* %95, i8* %97, i8* %99, i8* %101, i8* %103, i8* %105, i8* %107, i8* %109, i8* %111)
  br label %sw.epilog
...
sw.default:                                       ; preds = %if.end
  ...
  %call77 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %112, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.15.92, i64 0, i64 0), i8* %114, i8* %116, i8* %118, i8* %120, i8* %122, i8* %124, i8* %126, i8* %128, i8* %130)
  br label %sw.epilog
...
entry:
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call = call i32 @fputs_unlocked(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3.80, i64 0, i64 0), %struct._IO_FILE* %0)
...
if.else:                                          ; preds = %land.lhs.true, %entry
  call void @__assert_fail(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.121, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1.122, i64 0, i64 0), i32 84, i8* getelementptr inbounds ([79 x i8], [79 x i8]* @__PRETTY_FUNCTION__.xstrtoumax, i64 0, i64 0)) #12
  unreachable
...
if.end9:                                          ; preds = %while.end
  ...
  %call10 = call i64 @strtoumax(i8* %13, i8** %14, i32 %15) #10
...
if.end:                                           ; preds = %entry
  ...
  %call2 = call i32 @strcmp(i8* %arraydecay1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.137, i64 0, i64 0)) #13
  %cmp = icmp eq i32 %call2, 0
  br i1 %cmp, label %lor.end, label %lor.rhs

lor.rhs:                                          ; preds = %if.end
  %arraydecay3 = getelementptr inbounds [257 x i8], [257 x i8]* %locale, i64 0, i64 0
  %call4 = call i32 @strcmp(i8* %arraydecay3, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1.138, i64 0, i64 0)) #13
...
if.then:                                          ; preds = %entry
  store i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.141, i64 0, i64 0), i8** %codeset, align 8
  br label %if.end
...
if.then3:                                         ; preds = %if.end
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1.142, i64 0, i64 0), i8** %codeset, align 8
  br label %if.end4
