...
if.else:                                          ; preds = %if.end7
  ...
  %call13 = call i32 @lstat(i8* %9, %struct.stat* %st) #11
...
lor.lhs.false19:                                  ; preds = %if.else16
  %11 = load i64, i64* %filelen, align 8
  %cmp20 = icmp eq i64 %11, 0
  br i1 %cmp20, label %if.then21, label %if.end24

if.then21:                                        ; preds = %lor.lhs.false19, %if.else16
  %call22 = call i32* @__errno_location() #15
  %12 = load i32, i32* %call22, align 4
  %13 = load i8*, i8** %file.addr, align 8
  %call23 = call i8* @quotearg_n_style_colon(i32 0, i32 3, i8* %13)
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %12, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.33, i64 0, i64 0), i8* %call23)
  store i1 false, i1* %retval, align 1
  br label %return
...
if.end26:                                         ; preds = %if.end25, %if.end12
  %14 = load i8, i8* %check_basic_portability.addr, align 1
  %tobool27 = trunc i8 %14 to i1
  br i1 %tobool27, label %if.then32, label %lor.lhs.false28

lor.lhs.false28:                                  ; preds = %if.end26
  %15 = load i8, i8* %file_exists, align 1
  %tobool29 = trunc i8 %15 to i1
  br i1 %tobool29, label %if.end58, label %land.lhs.true30

land.lhs.true30:                                  ; preds = %lor.lhs.false28
  %16 = load i64, i64* %filelen, align 8
  %cmp31 = icmp ule i64 256, %16
  br i1 %cmp31, label %if.then32, label %if.end58

if.then32:                                        ; preds = %land.lhs.true30, %if.end26
  %17 = load i8, i8* %check_basic_portability.addr, align 1
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond51 = phi i64 [ %27, %cond.true ], [ 9223372036854775807, %cond.false ]
  store i64 %cond51, i64* %maxsize, align 8
  br label %if.end52

if.end52:                                         ; preds = %cond.end, %if.then34
  %28 = load i64, i64* %maxsize, align 8
  %29 = load i64, i64* %filelen, align 8
  %cmp53 = icmp ule i64 %28, %29
  br i1 %cmp53, label %if.then55, label %if.end57

if.then55:                                        ; preds = %if.end52
  %30 = load i64, i64* %filelen, align 8
  store i64 %30, i64* %len, align 8
  %31 = load i64, i64* %maxsize, align 8
  %sub = sub i64 %31, 1
  store i64 %sub, i64* %maxlen, align 8
  %32 = load i64, i64* %maxlen, align 8
  %33 = load i64, i64* %len, align 8
  %34 = load i8*, i8** %file.addr, align 8
  %call56 = call i8* @quotearg_style(i32 4, i8* %34)
  call void (i32, i32, i8*, ...) @error(i32 0, i32 0, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.37, i64 0, i64 0), i64 %32, i64 %33, i8* %call56)
  store i1 false, i1* %retval, align 1
  br label %return
...
if.end71:                                         ; preds = %for.body
  ...
  %add.ptr = getelementptr inbounds i8, i8* %44, i64 %43
...
cond.end93:                                       ; preds = %cond.false92, %cond.true91
  %cond94 = phi i8* [ getelementptr inbounds ([2 x i8], [2 x i8]* @.str.35, i64 0, i64 0), %cond.true91 ], [ %55, %cond.false92 ]
...
cond.end104:                                      ; preds = %cond.false103, %cond.true102
  %cond105 = phi i64 [ %64, %cond.true102 ], [ 9223372036854775807, %cond.false103 ]
  store i64 %cond105, i64* %name_max, align 8
  br label %if.end111

if.else106:                                       ; preds = %cond.end93
  %call107 = call i32* @__errno_location() #15
  %65 = load i32, i32* %call107, align 4
  switch i32 %65, label %sw.default [
    i32 0, label %sw.bb
    i32 2, label %sw.bb108
  ]

sw.bb:                                            ; preds = %if.else106
  store i64 -1, i64* %name_max, align 8
  br label %sw.epilog

sw.bb108:                                         ; preds = %if.else106
  %66 = load i64, i64* %name_max, align 8
  store i64 %66, i64* %known_name_max, align 8
  br label %sw.epilog

sw.default:                                       ; preds = %if.else106
  %67 = load i8*, i8** %start, align 8
  store i8 0, i8* %67, align 1
  %call109 = call i32* @__errno_location() #15
  %68 = load i32, i32* %call109, align 4
  %69 = load i8*, i8** %dir88, align 8
  %call110 = call i8* @quotearg_n_style_colon(i32 0, i32 3, i8* %69)
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %68, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.33, i64 0, i64 0), i8* %call110)
...
sw.epilog:                                        ; preds = %sw.bb108, %sw.bb
  br label %if.end111

if.end111:                                        ; preds = %sw.epilog, %cond.end104
  br label %if.end112

if.end112:                                        ; preds = %if.end111, %if.then85
  %72 = load i8*, i8** %start, align 8
  %call113 = call i64 @component_len(i8* %72) #13
  store i64 %call113, i64* %length83, align 8
  %73 = load i64, i64* %name_max, align 8
  %74 = load i64, i64* %length83, align 8
  %cmp114 = icmp ult i64 %73, %74
  br i1 %cmp114, label %if.then116, label %if.end123

if.then116:                                       ; preds = %if.end112
  %75 = load i64, i64* %length83, align 8
  store i64 %75, i64* %len117, align 8
  %76 = load i64, i64* %name_max, align 8
  store i64 %76, i64* %maxlen118, align 8
  %77 = load i8*, i8** %start, align 8
  %78 = load i64, i64* %len117, align 8
  %arrayidx = getelementptr inbounds i8, i8* %77, i64 %78
  %79 = load i8, i8* %arrayidx, align 1
  store i8 %79, i8* %c119, align 1
  %80 = load i8*, i8** %start, align 8
  %81 = load i64, i64* %len117, align 8
  %arrayidx120 = getelementptr inbounds i8, i8* %80, i64 %81
  store i8 0, i8* %arrayidx120, align 1
  %82 = load i64, i64* %maxlen118, align 8
  %83 = load i64, i64* %len117, align 8
  %84 = load i8*, i8** %start, align 8
  %call121 = call i8* @quote(i8* %84)
  call void (i32, i32, i8*, ...) @error(i32 0, i32 0, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.38, i64 0, i64 0), i64 %82, i64 %83, i8* %call121)
  %85 = load i8, i8* %c119, align 1
  %86 = load i8*, i8** %start, align 8
  %87 = load i64, i64* %len117, align 8
  %arrayidx122 = getelementptr inbounds i8, i8* %86, i64 %87
  store i8 %85, i8* %arrayidx122, align 1
  store i1 false, i1* %retval, align 1
  br label %return

if.end123:                                        ; preds = %if.end112
  %88 = load i64, i64* %length83, align 8
  %89 = load i8*, i8** %start, align 8
  %add.ptr124 = getelementptr inbounds i8, i8* %89, i64 %88
  store i8* %add.ptr124, i8** %start, align 8
  br label %for.cond79

for.end125:                                       ; preds = %for.cond79
  br label %if.end126

if.end126:                                        ; preds = %for.end125, %if.end72
...
if.then:                                          ; preds = %entry
  ...
  %6 = load i8*, i8** %invalid, align 8
  %7 = load i64, i64* %filelen.addr, align 8
  %8 = load i64, i64* %validlen, align 8
  %sub = sub i64 %7, %8
  %call1 = call i64 @rpl_mbrlen(i8* %6, i64 %sub, %struct.__mbstate_t* %mbstate)
  store i64 %call1, i64* %charlen, align 8
  %9 = load i8*, i8** %invalid, align 8
  %10 = load i64, i64* %charlen, align 8
  %cmp = icmp ule i64 %10, 16
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call2 = call i8* @quotearg_n_style_mem(i32 1, i32 8, i8* %9, i64 %cond)
  %12 = load i8*, i8** %file.addr, align 8
  %call3 = call i8* @quotearg_n_style(i32 0, i32 4, i8* %12)
...
if.else:                                          ; preds = %if.then
  ...
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %7, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2.47, i64 0, i64 0), i8* %8)
  br label %if.end
...
if.else:                                          ; preds = %entry
  ...
  %call1 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1.89, i64 0, i64 0), i8* %6, i8* %7)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %8, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @version_etc_copyright, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2.90, i64 0, i64 0), i32 2020)
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call3 = call i32 @fputs_unlocked(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3.91, i64 0, i64 0), %struct._IO_FILE* %9)
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call4 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %10, i8* getelementptr inbounds ([171 x i8], [171 x i8]* @.str.4.92, i64 0, i64 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.5.93, i64 0, i64 0))
  %11 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call5 = call i32 @fputs_unlocked(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3.91, i64 0, i64 0), %struct._IO_FILE* %11)
...
sw.bb6:                                           ; preds = %if.end
  ...
  %call7 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %13, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.6.94, i64 0, i64 0), i8* %15)
  br label %sw.epilog
...
sw.bb8:                                           ; preds = %if.end
  ...
  %call11 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %16, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7.95, i64 0, i64 0), i8* %18, i8* %20)
  br label %sw.epilog
...
sw.bb12:                                          ; preds = %if.end
  ...
  %call16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %21, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.8.96, i64 0, i64 0), i8* %23, i8* %25, i8* %27)
  br label %sw.epilog
...
sw.bb17:                                          ; preds = %if.end
  ...
  %call22 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %28, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.9.97, i64 0, i64 0), i8* %30, i8* %32, i8* %34, i8* %36)
  br label %sw.epilog
...
sw.bb23:                                          ; preds = %if.end
  ...
  %call29 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %37, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.10.98, i64 0, i64 0), i8* %39, i8* %41, i8* %43, i8* %45, i8* %47)
  br label %sw.epilog
...
sw.bb30:                                          ; preds = %if.end
  ...
  %call37 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.11.99, i64 0, i64 0), i8* %50, i8* %52, i8* %54, i8* %56, i8* %58, i8* %60)
  br label %sw.epilog
...
sw.bb38:                                          ; preds = %if.end
  ...
  %call46 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %61, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.12.100, i64 0, i64 0), i8* %63, i8* %65, i8* %67, i8* %69, i8* %71, i8* %73, i8* %75)
  br label %sw.epilog
...
sw.bb47:                                          ; preds = %if.end
  ...
  %call56 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %76, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.13.101, i64 0, i64 0), i8* %78, i8* %80, i8* %82, i8* %84, i8* %86, i8* %88, i8* %90, i8* %92)
  br label %sw.epilog
...
sw.bb57:                                          ; preds = %if.end
  ...
  %call67 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %93, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.14.102, i64 0, i64 0), i8* %95, i8* %97, i8* %99, i8* %101, i8* %103, i8* %105, i8* %107, i8* %109, i8* %111)
  br label %sw.epilog
...
sw.default:                                       ; preds = %if.end
  ...
  %call77 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %112, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.15.103, i64 0, i64 0), i8* %114, i8* %116, i8* %118, i8* %120, i8* %122, i8* %124, i8* %126, i8* %128, i8* %130)
  br label %sw.epilog
...
if.then:                                          ; preds = %entry
  store %struct.__mbstate_t* @internal_state, %struct.__mbstate_t** %ps.addr, align 8
  br label %if.end
...
if.then:                                          ; preds = %entry
  store i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.139, i64 0, i64 0), i8** %codeset, align 8
  br label %if.end
...
if.then3:                                         ; preds = %if.end
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1.140, i64 0, i64 0), i8** %codeset, align 8
  br label %if.end4
