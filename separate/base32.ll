...
if.then:                                          ; preds = %do.end
  ...
  %div = udiv i64 %add8, 5
  %mul = mul i64 %div, 8
  call void @base32_encode(i8* %11, i64 %12, i8* %13, i64 %mul)
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %shr12, %cond.true ], [ 0, %cond.false ]
...
if.end20:                                         ; preds = %cond.end
  ...
  br i1 %tobool21, label %cond.true22, label %cond.false31
...
cond.false31:                                     ; preds = %if.end20
  br label %cond.end32

cond.end32:                                       ; preds = %cond.false31, %cond.true22
  %cond33 = phi i32 [ %conv30, %cond.true22 ], [ 61, %cond.false31 ]
...
if.end39:                                         ; preds = %cond.end32
  ...
  br i1 %tobool40, label %cond.true41, label %cond.false61
...
cond.false53:                                     ; preds = %cond.true41
  br label %cond.end54

cond.end54:                                       ; preds = %cond.false53, %cond.true48
  %cond55 = phi i32 [ %shr52, %cond.true48 ], [ 0, %cond.false53 ]
...
cond.false61:                                     ; preds = %if.end39
  br label %cond.end62

cond.end62:                                       ; preds = %cond.false61, %cond.end54
  %cond63 = phi i32 [ %conv60, %cond.end54 ], [ 61, %cond.false61 ]
...
if.end69:                                         ; preds = %cond.end62
  ...
  br i1 %tobool70, label %cond.true71, label %cond.false91
...
cond.end84:                                       ; preds = %cond.false83, %cond.true78
  %cond85 = phi i32 [ %shr82, %cond.true78 ], [ 0, %cond.false83 ]
...
cond.false91:                                     ; preds = %if.end69
  br label %cond.end92

cond.end92:                                       ; preds = %cond.false91, %cond.end84
  %cond93 = phi i32 [ %conv90, %cond.end84 ], [ 61, %cond.false91 ]
...
if.end99:                                         ; preds = %cond.end92
  ...
  br i1 %tobool100, label %cond.true101, label %cond.false110
...
cond.false110:                                    ; preds = %if.end99
  br label %cond.end111

cond.end111:                                      ; preds = %cond.false110, %cond.true101
  %cond112 = phi i32 [ %conv109, %cond.true101 ], [ 61, %cond.false110 ]
...
if.end118:                                        ; preds = %cond.end111
  ...
  br i1 %tobool119, label %cond.true120, label %cond.false140
...
cond.true120:                                     ; preds = %if.end118
  ...
  br i1 %tobool126, label %cond.true127, label %cond.false132
...
cond.false132:                                    ; preds = %cond.true120
  br label %cond.end133

cond.end133:                                      ; preds = %cond.false132, %cond.true127
  %cond134 = phi i32 [ %shr131, %cond.true127 ], [ 0, %cond.false132 ]
...
cond.false140:                                    ; preds = %if.end118
  br label %cond.end141

cond.end141:                                      ; preds = %cond.false140, %cond.end133
  %cond142 = phi i32 [ %conv139, %cond.end133 ], [ 61, %cond.false140 ]
...
if.end148:                                        ; preds = %cond.end141
  ...
  br i1 %tobool149, label %cond.true150, label %cond.false158
...
cond.false158:                                    ; preds = %if.end148
  br label %cond.end159

cond.end159:                                      ; preds = %cond.false158, %cond.true150
  %cond160 = phi i32 [ %conv157, %cond.true150 ], [ 61, %cond.false158 ]
...
while.end:                                        ; preds = %if.then165, %if.then147, %if.then117, %if.then98, %if.then68, %if.then38, %if.then19, %if.then, %land.end
...
lor.lhs.false25:                                  ; preds = %if.then20
  ...
  br i1 %cmp28, label %if.then45, label %lor.lhs.false30
...
if.then45:                                        ; preds = %lor.lhs.false40, %lor.lhs.false35, %lor.lhs.false30, %lor.lhs.false25, %if.then20
  br label %do.body
...
if.end46:                                         ; preds = %do.end, %lor.lhs.false40
  br label %if.end217

if.else:                                          ; preds = %if.end15
  %32 = load i8*, i8** %in.addr, align 8
  %arrayidx47 = getelementptr inbounds i8, i8* %32, i64 2
  %33 = load i8, i8* %arrayidx47, align 1
  %call48 = call zeroext i1 @isbase32(i8 signext %33) #16
  br i1 %call48, label %lor.lhs.false49, label %if.then52

lor.lhs.false49:                                  ; preds = %if.else
  %34 = load i8*, i8** %in.addr, align 8
  %arrayidx50 = getelementptr inbounds i8, i8* %34, i64 3
  %35 = load i8, i8* %arrayidx50, align 1
  %call51 = call zeroext i1 @isbase32(i8 signext %35) #16
  br i1 %call51, label %if.end55, label %if.then52

if.then52:                                        ; preds = %lor.lhs.false49, %if.else
  br label %do.body53

do.body53:                                        ; preds = %if.then52
  %36 = load i8*, i8** %out, align 8
  %37 = load i8**, i8*** %outp.addr, align 8
...
if.end55:                                         ; preds = %do.end54, %lor.lhs.false49
  ...
  %tobool56 = icmp ne i64 %39, 0
  br i1 %tobool56, label %if.then57, label %if.end81

if.then57:                                        ; preds = %if.end55
  %40 = load i8*, i8** %in.addr, align 8
  %arrayidx58 = getelementptr inbounds i8, i8* %40, i64 1
  %41 = load i8, i8* %arrayidx58, align 1
  %call59 = call zeroext i8 @to_uchar(i8 signext %41)
  ...
  %arrayidx64 = getelementptr inbounds i8, i8* %43, i64 2
  %44 = load i8, i8* %arrayidx64, align 1
  %call65 = call zeroext i8 @to_uchar(i8 signext %44)
  ...
  %arrayidx71 = getelementptr inbounds i8, i8* %46, i64 3
  %47 = load i8, i8* %arrayidx71, align 1
  %call72 = call zeroext i8 @to_uchar(i8 signext %47)
  ...
  %49 = load i8*, i8** %out, align 8
  %incdec.ptr79 = getelementptr inbounds i8, i8* %49, i32 1
  store i8* %incdec.ptr79, i8** %out, align 8
  store i8 %conv78, i8* %49, align 1
  %50 = load i64*, i64** %outleft.addr, align 8
  %51 = load i64, i64* %50, align 8
  %dec80 = add i64 %51, -1
  store i64 %dec80, i64* %50, align 8
  br label %if.end81

if.end81:                                         ; preds = %if.then57, %if.end55
  %52 = load i8*, i8** %in.addr, align 8
  %arrayidx82 = getelementptr inbounds i8, i8* %52, i64 4
...
lor.lhs.false91:                                  ; preds = %if.then86
  %56 = load i8*, i8** %in.addr, align 8
  %arrayidx92 = getelementptr inbounds i8, i8* %56, i64 6
...
lor.lhs.false96:                                  ; preds = %lor.lhs.false91
  ...
  %arrayidx97 = getelementptr inbounds i8, i8* %58, i64 7
...
if.then101:                                       ; preds = %lor.lhs.false96, %lor.lhs.false91, %if.then86
  br label %do.body102

do.body102:                                       ; preds = %if.then101
  %60 = load i8*, i8** %out, align 8
  %61 = load i8**, i8*** %outp.addr, align 8
...
if.end104:                                        ; preds = %do.end103, %lor.lhs.false96
  br label %if.end216

if.else105:                                       ; preds = %if.end81
  %62 = load i8*, i8** %in.addr, align 8
  %arrayidx106 = getelementptr inbounds i8, i8* %62, i64 4
  %63 = load i8, i8* %arrayidx106, align 1
  %call107 = call zeroext i1 @isbase32(i8 signext %63) #16
...
do.body109:                                       ; preds = %if.then108
  ...
  %65 = load i8**, i8*** %outp.addr, align 8
...
if.end111:                                        ; preds = %do.end110, %if.else105
  %66 = load i64*, i64** %outleft.addr, align 8
  %67 = load i64, i64* %66, align 8
  %tobool112 = icmp ne i64 %67, 0
  br i1 %tobool112, label %if.then113, label %if.end130

if.then113:                                       ; preds = %if.end111
  %68 = load i8*, i8** %in.addr, align 8
  %arrayidx114 = getelementptr inbounds i8, i8* %68, i64 3
  %69 = load i8, i8* %arrayidx114, align 1
  %call115 = call zeroext i8 @to_uchar(i8 signext %69)
  %idxprom116 = zext i8 %call115 to i64
  %arrayidx117 = getelementptr inbounds [256 x i8], [256 x i8]* @b32, i64 0, i64 %idxprom116
  %70 = load i8, i8* %arrayidx117, align 1
  %conv118 = sext i8 %70 to i32
  %shl119 = shl i32 %conv118, 4
  %71 = load i8*, i8** %in.addr, align 8
  %arrayidx120 = getelementptr inbounds i8, i8* %71, i64 4
  %72 = load i8, i8* %arrayidx120, align 1
  %call121 = call zeroext i8 @to_uchar(i8 signext %72)
  ...
  %incdec.ptr128 = getelementptr inbounds i8, i8* %74, i32 1
  store i8* %incdec.ptr128, i8** %out, align 8
  store i8 %conv127, i8* %74, align 1
  %75 = load i64*, i64** %outleft.addr, align 8
  %76 = load i64, i64* %75, align 8
  %dec129 = add i64 %76, -1
  store i64 %dec129, i64* %75, align 8
  br label %if.end130

if.end130:                                        ; preds = %if.then113, %if.end111
  %77 = load i8*, i8** %in.addr, align 8
  %arrayidx131 = getelementptr inbounds i8, i8* %77, i64 5
  %78 = load i8, i8* %arrayidx131, align 1
  %conv132 = sext i8 %78 to i32
...
if.then135:                                       ; preds = %if.end130
  ...
  %arrayidx136 = getelementptr inbounds i8, i8* %79, i64 6
  %80 = load i8, i8* %arrayidx136, align 1
  %conv137 = sext i8 %80 to i32
...
lor.lhs.false140:                                 ; preds = %if.then135
  ...
  %arrayidx141 = getelementptr inbounds i8, i8* %81, i64 7
...
if.then145:                                       ; preds = %lor.lhs.false140, %if.then135
  br label %do.body146

do.body146:                                       ; preds = %if.then145
  %83 = load i8*, i8** %out, align 8
  %84 = load i8**, i8*** %outp.addr, align 8
...
if.end148:                                        ; preds = %do.end147, %lor.lhs.false140
  br label %if.end215

if.else149:                                       ; preds = %if.end130
  %85 = load i8*, i8** %in.addr, align 8
  %arrayidx150 = getelementptr inbounds i8, i8* %85, i64 5
  %86 = load i8, i8* %arrayidx150, align 1
  %call151 = call zeroext i1 @isbase32(i8 signext %86) #16
  br i1 %call151, label %lor.lhs.false152, label %if.then155

lor.lhs.false152:                                 ; preds = %if.else149
  %87 = load i8*, i8** %in.addr, align 8
  %arrayidx153 = getelementptr inbounds i8, i8* %87, i64 6
  %88 = load i8, i8* %arrayidx153, align 1
  %call154 = call zeroext i1 @isbase32(i8 signext %88) #16
  br i1 %call154, label %if.end158, label %if.then155

if.then155:                                       ; preds = %lor.lhs.false152, %if.else149
  br label %do.body156

do.body156:                                       ; preds = %if.then155
  %89 = load i8*, i8** %out, align 8
  %90 = load i8**, i8*** %outp.addr, align 8
...
if.end158:                                        ; preds = %do.end157, %lor.lhs.false152
  %91 = load i64*, i64** %outleft.addr, align 8
  %92 = load i64, i64* %91, align 8
  %tobool159 = icmp ne i64 %92, 0
  br i1 %tobool159, label %if.then160, label %if.end184

if.then160:                                       ; preds = %if.end158
  %93 = load i8*, i8** %in.addr, align 8
  %arrayidx161 = getelementptr inbounds i8, i8* %93, i64 4
  %94 = load i8, i8* %arrayidx161, align 1
  %call162 = call zeroext i8 @to_uchar(i8 signext %94)
  ...
  %conv165 = sext i8 %95 to i32
  %shl166 = shl i32 %conv165, 7
  %96 = load i8*, i8** %in.addr, align 8
  %arrayidx167 = getelementptr inbounds i8, i8* %96, i64 5
  %97 = load i8, i8* %arrayidx167, align 1
  %call168 = call zeroext i8 @to_uchar(i8 signext %97)
  ...
  %99 = load i8*, i8** %in.addr, align 8
  %arrayidx174 = getelementptr inbounds i8, i8* %99, i64 6
  %100 = load i8, i8* %arrayidx174, align 1
  %call175 = call zeroext i8 @to_uchar(i8 signext %100)
  ...
  %conv178 = sext i8 %101 to i32
  %shr179 = ashr i32 %conv178, 3
  %or180 = or i32 %or173, %shr179
  %conv181 = trunc i32 %or180 to i8
  %102 = load i8*, i8** %out, align 8
  %incdec.ptr182 = getelementptr inbounds i8, i8* %102, i32 1
  store i8* %incdec.ptr182, i8** %out, align 8
  store i8 %conv181, i8* %102, align 1
  %103 = load i64*, i64** %outleft.addr, align 8
  %104 = load i64, i64* %103, align 8
  %dec183 = add i64 %104, -1
  store i64 %dec183, i64* %103, align 8
  br label %if.end184

if.end184:                                        ; preds = %if.then160, %if.end158
  %105 = load i8*, i8** %in.addr, align 8
  %arrayidx185 = getelementptr inbounds i8, i8* %105, i64 7
  %106 = load i8, i8* %arrayidx185, align 1
  %conv186 = sext i8 %106 to i32
  %cmp187 = icmp ne i32 %conv186, 61
  br i1 %cmp187, label %if.then189, label %if.end214

if.then189:                                       ; preds = %if.end184
  %107 = load i8*, i8** %in.addr, align 8
  %arrayidx190 = getelementptr inbounds i8, i8* %107, i64 7
  %108 = load i8, i8* %arrayidx190, align 1
  %call191 = call zeroext i1 @isbase32(i8 signext %108) #16
...
do.body193:                                       ; preds = %if.then192
  ...
  %110 = load i8**, i8*** %outp.addr, align 8
...
if.end195:                                        ; preds = %do.end194, %if.then189
  %111 = load i64*, i64** %outleft.addr, align 8
  %112 = load i64, i64* %111, align 8
  %tobool196 = icmp ne i64 %112, 0
  br i1 %tobool196, label %if.then197, label %if.end213

if.then197:                                       ; preds = %if.end195
  %113 = load i8*, i8** %in.addr, align 8
  %arrayidx198 = getelementptr inbounds i8, i8* %113, i64 6
  %114 = load i8, i8* %arrayidx198, align 1
  %call199 = call zeroext i8 @to_uchar(i8 signext %114)
  %idxprom200 = zext i8 %call199 to i64
  %arrayidx201 = getelementptr inbounds [256 x i8], [256 x i8]* @b32, i64 0, i64 %idxprom200
  %115 = load i8, i8* %arrayidx201, align 1
  %conv202 = sext i8 %115 to i32
  %shl203 = shl i32 %conv202, 5
  %116 = load i8*, i8** %in.addr, align 8
  %arrayidx204 = getelementptr inbounds i8, i8* %116, i64 7
  %117 = load i8, i8* %arrayidx204, align 1
  %call205 = call zeroext i8 @to_uchar(i8 signext %117)
  %idxprom206 = zext i8 %call205 to i64
  %arrayidx207 = getelementptr inbounds [256 x i8], [256 x i8]* @b32, i64 0, i64 %idxprom206
  %118 = load i8, i8* %arrayidx207, align 1
  %conv208 = sext i8 %118 to i32
  %or209 = or i32 %shl203, %conv208
  %conv210 = trunc i32 %or209 to i8
  %119 = load i8*, i8** %out, align 8
  %incdec.ptr211 = getelementptr inbounds i8, i8* %119, i32 1
  store i8* %incdec.ptr211, i8** %out, align 8
  store i8 %conv210, i8* %119, align 1
  %120 = load i64*, i64** %outleft.addr, align 8
  %121 = load i64, i64* %120, align 8
  %dec212 = add i64 %121, -1
  store i64 %dec212, i64* %120, align 8
  br label %if.end213

if.end213:                                        ; preds = %if.then197, %if.end195
  br label %if.end214

if.end214:                                        ; preds = %if.end213, %if.end184
  br label %if.end215

if.end215:                                        ; preds = %if.end214, %if.end148
  br label %if.end216

if.end216:                                        ; preds = %if.end215, %if.end104
  br label %if.end217

if.end217:                                        ; preds = %if.end216, %if.end46
  %122 = load i8*, i8** %out, align 8
  %123 = load i8**, i8*** %outp.addr, align 8
