...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i8* [ getelementptr inbounds ([3 x i8], [3 x i8]* @.str.11, i64 0, i64 0), %cond.true ], [ %7, %cond.false ]
...
sw.epilog:                                        ; preds = %sw.bb7, %sw.bb6, %cond.end
  br label %while.cond
...
if.else:                                          ; preds = %while.body
  %9 = load i8*, i8** %strptr.addr, align 8
  %incdec.ptr3 = getelementptr inbounds i8, i8* %9, i32 1
  store i8* %incdec.ptr3, i8** %strptr.addr, align 8
...
sw.default:                                       ; preds = %if.else
  %19 = load i8*, i8** %strptr.addr, align 8
  %20 = load i8, i8* %19, align 1
  %21 = load i8*, i8** %strout, align 8
...
sw.epilog:                                        ; preds = %sw.default, %sw.bb18, %sw.bb16, %sw.bb14, %sw.bb12, %sw.bb10, %sw.bb8, %sw.bb6, %sw.bb
  %22 = load i8*, i8** %strptr.addr, align 8
...
done:                                             ; preds = %while.end, %sw.bb20
  %23 = load i8*, i8** %strout, align 8
  store i8* %23, i8** @delim_end, align 8
  %24 = load i8, i8* %backslash_at_end, align 1
  %tobool23 = trunc i8 %24 to i1
  %25 = zext i1 %tobool23 to i64
...
if.else44:                                        ; preds = %if.end41
  ...
  %call45 = call i32 @rpl_fclose(%struct._IO_FILE* %39)
  %cmp46 = icmp eq i32 %call45, -1
  br i1 %cmp46, label %if.then48, label %if.end51

if.then48:                                        ; preds = %if.else44
  %call49 = call i32* @__errno_location() #15
  %40 = load i32, i32* %call49, align 4
  %41 = load i8**, i8*** %fnamptr.addr, align 8
  %42 = load i8*, i8** %41, align 8
  %call50 = call i8* @quotearg_n_style_colon(i32 0, i32 3, i8* %42)
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %40, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.41, i64 0, i64 0), i8* %call50)
  store i8 0, i8* %ok, align 1
  br label %if.end51

if.end51:                                         ; preds = %if.then48, %if.else44
  br label %if.end52

if.end52:                                         ; preds = %if.end51, %if.then43
  br label %for.inc

for.inc:                                          ; preds = %if.end52, %if.then4
  %43 = load i64, i64* %nfiles.addr, align 8
  %dec = add i64 %43, -1
  store i64 %dec, i64* %nfiles.addr, align 8
  %44 = load i8**, i8*** %fnamptr.addr, align 8
...
if.end22:                                         ; preds = %if.end20, %if.then
  br label %for.inc
...
while.cond:                                       ; preds = %for.end149, %if.end25
...
land.end:                                         ; preds = %land.rhs, %for.cond27
  %37 = phi i1 [ false, %for.cond27 ], [ %tobool29, %land.rhs ]
  br i1 %37, label %for.body30, label %for.end149
...
if.end45:                                         ; preds = %if.end44, %land.lhs.true38, %if.then33
...
while.end:                                        ; preds = %if.then51, %while.cond46
  br label %if.end57

if.end57:                                         ; preds = %while.end, %for.body30
...
if.else75:                                        ; preds = %if.end69
  %77 = load %struct._IO_FILE**, %struct._IO_FILE*** %fileptr, align 8
  %78 = load i64, i64* %i, align 8
  %arrayidx76 = getelementptr inbounds %struct._IO_FILE*, %struct._IO_FILE** %77, i64 %78
  %79 = load %struct._IO_FILE*, %struct._IO_FILE** %arrayidx76, align 8
  %call77 = call i32 @rpl_fclose(%struct._IO_FILE* %79)
...
if.then80:                                        ; preds = %if.else75
  ...
  %80 = load i32, i32* %call81, align 4
  %81 = load i8**, i8*** %fnamptr.addr, align 8
  %82 = load i64, i64* %i, align 8
  %arrayidx82 = getelementptr inbounds i8*, i8** %81, i64 %82
  %83 = load i8*, i8** %arrayidx82, align 8
  %call83 = call i8* @quotearg_n_style_colon(i32 0, i32 3, i8* %83)
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %80, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.41, i64 0, i64 0), i8* %call83)
  store i8 0, i8* %ok, align 1
  br label %if.end84
...
if.end85:                                         ; preds = %if.end84, %if.then73
  %84 = load %struct._IO_FILE**, %struct._IO_FILE*** %fileptr, align 8
  %85 = load i64, i64* %i, align 8
  %arrayidx86 = getelementptr inbounds %struct._IO_FILE*, %struct._IO_FILE** %84, i64 %85
  store %struct._IO_FILE* null, %struct._IO_FILE** %arrayidx86, align 8
  %86 = load i64, i64* %files_open, align 8
  %dec = add i64 %86, -1
...
if.end87:                                         ; preds = %if.end85, %if.then59
  ...
  %add88 = add i64 %87, 1
  %88 = load i64, i64* %nfiles.addr, align 8
  %cmp89 = icmp eq i64 %add88, %88
  br i1 %cmp89, label %if.then91, label %if.else103

if.then91:                                        ; preds = %if.end87
  %89 = load i8, i8* %somedone, align 1
  %tobool92 = trunc i8 %89 to i1
  br i1 %tobool92, label %if.then93, label %if.end102

if.then93:                                        ; preds = %if.then91
  %90 = load i64, i64* %delims_saved, align 8
  %tobool94 = icmp ne i64 %90, 0
  br i1 %tobool94, label %if.then95, label %if.end101

if.then95:                                        ; preds = %if.then93
  %91 = load i8*, i8** %delbuf, align 8
  %92 = load i64, i64* %delims_saved, align 8
  %93 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call96 = call i64 @fwrite_unlocked(i8* %91, i64 1, i64 %92, %struct._IO_FILE* %93)
  %94 = load i64, i64* %delims_saved, align 8
  %cmp97 = icmp ne i64 %call96, %94
...
if.end101:                                        ; preds = %if.end100, %if.then93
  %95 = load i8, i8* @line_delim, align 1
  call void @xputchar(i8 signext %95)
  br label %if.end102
...
if.else103:                                       ; preds = %if.end87
  %96 = load i8*, i8** %delimptr, align 8
  %97 = load i8, i8* %96, align 1
  %conv104 = sext i8 %97 to i32
  %cmp105 = icmp ne i32 %conv104, 0
  br i1 %cmp105, label %if.then107, label %if.end110

if.then107:                                       ; preds = %if.else103
  %98 = load i8*, i8** %delimptr, align 8
  %99 = load i8, i8* %98, align 1
  %100 = load i8*, i8** %delbuf, align 8
  %101 = load i64, i64* %delims_saved, align 8
  %inc108 = add i64 %101, 1
  store i64 %inc108, i64* %delims_saved, align 8
  %arrayidx109 = getelementptr inbounds i8, i8* %100, i64 %101
  store i8 %99, i8* %arrayidx109, align 1
  br label %if.end110

if.end110:                                        ; preds = %if.then107, %if.else103
  %102 = load i8*, i8** %delimptr, align 8
  %incdec.ptr = getelementptr inbounds i8, i8* %102, i32 1
  store i8* %incdec.ptr, i8** %delimptr, align 8
  %103 = load i8*, i8** @delim_end, align 8
  %cmp111 = icmp eq i8* %incdec.ptr, %103
  br i1 %cmp111, label %if.then113, label %if.end114

if.then113:                                       ; preds = %if.end110
  %104 = load i8*, i8** @delims, align 8
  store i8* %104, i8** %delimptr, align 8
  br label %if.end114
...
if.else116:                                       ; preds = %if.end57
  ...
  %add117 = add i64 %105, 1
  %106 = load i64, i64* %nfiles.addr, align 8
  %cmp118 = icmp ne i64 %add117, %106
  br i1 %cmp118, label %if.then120, label %if.else140

if.then120:                                       ; preds = %if.else116
  %107 = load i32, i32* %chr, align 4
  %108 = load i8, i8* @line_delim, align 1
  %conv121 = zext i8 %108 to i32
  %cmp122 = icmp ne i32 %107, %conv121
  br i1 %cmp122, label %land.lhs.true124, label %if.end129

land.lhs.true124:                                 ; preds = %if.then120
  %109 = load i32, i32* %chr, align 4
  %cmp125 = icmp ne i32 %109, -1
  br i1 %cmp125, label %if.then127, label %if.end129

if.then127:                                       ; preds = %land.lhs.true124
  %110 = load i32, i32* %chr, align 4
  %conv128 = trunc i32 %110 to i8
  call void @xputchar(i8 signext %conv128)
  br label %if.end129

if.end129:                                        ; preds = %if.then127, %land.lhs.true124, %if.then120
  %111 = load i8*, i8** %delimptr, align 8
  %112 = load i8, i8* %111, align 1
  %conv130 = sext i8 %112 to i32
  %cmp131 = icmp ne i32 %conv130, 0
  br i1 %cmp131, label %if.then133, label %if.end134

if.then133:                                       ; preds = %if.end129
  %113 = load i8*, i8** %delimptr, align 8
  %114 = load i8, i8* %113, align 1
  call void @xputchar(i8 signext %114)
  br label %if.end134

if.end134:                                        ; preds = %if.then133, %if.end129
  %115 = load i8*, i8** %delimptr, align 8
  %incdec.ptr135 = getelementptr inbounds i8, i8* %115, i32 1
  store i8* %incdec.ptr135, i8** %delimptr, align 8
  %116 = load i8*, i8** @delim_end, align 8
  %cmp136 = icmp eq i8* %incdec.ptr135, %116
  br i1 %cmp136, label %if.then138, label %if.end139

if.then138:                                       ; preds = %if.end134
  %117 = load i8*, i8** @delims, align 8
  store i8* %117, i8** %delimptr, align 8
  br label %if.end139
...
if.else140:                                       ; preds = %if.else116
  %118 = load i32, i32* %chr, align 4
  %cmp141 = icmp eq i32 %118, -1
  br i1 %cmp141, label %cond.true, label %cond.false

cond.true:                                        ; preds = %if.else140
  %119 = load i8, i8* @line_delim, align 1
  %conv143 = zext i8 %119 to i32
  br label %cond.end

cond.false:                                       ; preds = %if.else140
  %120 = load i32, i32* %chr, align 4
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %conv143, %cond.true ], [ %120, %cond.false ]
  %conv144 = trunc i32 %cond to i8
  store i8 %conv144, i8* %c, align 1
  %121 = load i8, i8* %c, align 1
  call void @xputchar(i8 signext %121)
  br label %if.end145

if.end145:                                        ; preds = %cond.end, %if.end139
  br label %if.end146

if.end146:                                        ; preds = %if.end145, %if.end115
  br label %for.inc147

for.inc147:                                       ; preds = %if.end146, %if.end102
...
while.end150:                                     ; preds = %while.cond
  %123 = load %struct._IO_FILE**, %struct._IO_FILE*** %fileptr, align 8
  %124 = bitcast %struct._IO_FILE** %123 to i8*
  call void @free(i8* %124) #10
  %125 = load i8*, i8** %delbuf, align 8
  call void @free(i8* %125) #10
  %126 = load i8, i8* %ok, align 1
  %tobool151 = trunc i8 %126 to i1
  ret i1 %tobool151
}
...
if.else:                                          ; preds = %if.then
  ...
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %7, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2.49, i64 0, i64 0), i8* %8)
  br label %if.end
...
if.else:                                          ; preds = %entry
  ...
  %call1 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1.85, i64 0, i64 0), i8* %6, i8* %7)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %8, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @version_etc_copyright, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2.86, i64 0, i64 0), i32 2020)
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call3 = call i32 @fputs_unlocked(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3.87, i64 0, i64 0), %struct._IO_FILE* %9)
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call4 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %10, i8* getelementptr inbounds ([171 x i8], [171 x i8]* @.str.4.88, i64 0, i64 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.5.89, i64 0, i64 0))
  %11 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call5 = call i32 @fputs_unlocked(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3.87, i64 0, i64 0), %struct._IO_FILE* %11)
...
sw.bb6:                                           ; preds = %if.end
  ...
  %call7 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %13, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.6.90, i64 0, i64 0), i8* %15)
  br label %sw.epilog
...
sw.bb8:                                           ; preds = %if.end
  ...
  %call11 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %16, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7.91, i64 0, i64 0), i8* %18, i8* %20)
  br label %sw.epilog
...
sw.bb12:                                          ; preds = %if.end
  ...
  %call16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %21, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.8.92, i64 0, i64 0), i8* %23, i8* %25, i8* %27)
  br label %sw.epilog
...
sw.bb17:                                          ; preds = %if.end
  ...
  %call22 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %28, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.9.93, i64 0, i64 0), i8* %30, i8* %32, i8* %34, i8* %36)
  br label %sw.epilog
...
sw.bb23:                                          ; preds = %if.end
  ...
  %call29 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %37, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.10.94, i64 0, i64 0), i8* %39, i8* %41, i8* %43, i8* %45, i8* %47)
  br label %sw.epilog
...
sw.bb30:                                          ; preds = %if.end
  ...
  %call37 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.11.95, i64 0, i64 0), i8* %50, i8* %52, i8* %54, i8* %56, i8* %58, i8* %60)
  br label %sw.epilog
...
sw.bb38:                                          ; preds = %if.end
  ...
  %call46 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %61, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.12.96, i64 0, i64 0), i8* %63, i8* %65, i8* %67, i8* %69, i8* %71, i8* %73, i8* %75)
  br label %sw.epilog
...
sw.bb47:                                          ; preds = %if.end
  ...
  %call56 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %76, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.13.97, i64 0, i64 0), i8* %78, i8* %80, i8* %82, i8* %84, i8* %86, i8* %88, i8* %90, i8* %92)
  br label %sw.epilog
...
sw.bb57:                                          ; preds = %if.end
  ...
  %call67 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %93, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.14.98, i64 0, i64 0), i8* %95, i8* %97, i8* %99, i8* %101, i8* %103, i8* %105, i8* %107, i8* %109, i8* %111)
  br label %sw.epilog
...
sw.default:                                       ; preds = %if.end
  ...
  %call77 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %112, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.15.99, i64 0, i64 0), i8* %114, i8* %116, i8* %118, i8* %120, i8* %122, i8* %124, i8* %126, i8* %128, i8* %130)
  br label %sw.epilog
...
if.end:                                           ; preds = %land.lhs.true, %entry
  ...
  %call = call i8* @realloc(i8* %3, i64 %4) #10
...
if.then:                                          ; preds = %entry
  store i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.145, i64 0, i64 0), i8** %codeset, align 8
  br label %if.end
...
if.then3:                                         ; preds = %if.end
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1.146, i64 0, i64 0), i8** %codeset, align 8
  br label %if.end4
