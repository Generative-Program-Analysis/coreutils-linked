...
NodeBlock17:                                      ; preds = %while.body
  %case.cmp18 = icmp eq i32 %4, 49
  br i1 %case.cmp18, label %sw.bb, label %NodeBlock15

NodeBlock15:                                      ; preds = %NodeBlock17
  %case.cmp16 = icmp eq i32 %4, 50
  br i1 %case.cmp16, label %sw.bb4, label %NodeBlock13

NodeBlock13:                                      ; preds = %NodeBlock15
  %case.cmp14 = icmp eq i32 %4, 51
  br i1 %case.cmp14, label %sw.bb5, label %NodeBlock11

NodeBlock11:                                      ; preds = %NodeBlock13
  %case.cmp12 = icmp eq i32 %4, 122
  br i1 %case.cmp12, label %sw.bb6, label %NodeBlock9

NodeBlock9:                                       ; preds = %NodeBlock11
  %case.cmp10 = icmp eq i32 %4, 129
  br i1 %case.cmp10, label %sw.bb7, label %NodeBlock7

NodeBlock7:                                       ; preds = %NodeBlock9
  %case.cmp8 = icmp eq i32 %4, 128
  br i1 %case.cmp8, label %sw.bb8, label %NodeBlock5

NodeBlock5:                                       ; preds = %NodeBlock7
  %case.cmp6 = icmp eq i32 %4, 130
  br i1 %case.cmp6, label %sw.bb9, label %NodeBlock3

NodeBlock3:                                       ; preds = %NodeBlock5
  %case.cmp4 = icmp eq i32 %4, 131
  br i1 %case.cmp4, label %sw.bb14, label %NodeBlock1

NodeBlock1:                                       ; preds = %NodeBlock3
  %case.cmp2 = icmp eq i32 %4, -130
  br i1 %case.cmp2, label %sw.bb15, label %NodeBlock

NodeBlock:                                        ; preds = %NodeBlock1
  %case.cmp = icmp eq i32 %4, -131
  br i1 %case.cmp, label %sw.bb16, label %newDefault

sw.bb:                                            ; preds = %NodeBlock17
  store i8 0, i8* @only_file_1, align 1
  br label %sw.epilog

sw.bb4:                                           ; preds = %NodeBlock15
  store i8 0, i8* @only_file_2, align 1
  br label %sw.epilog

sw.bb5:                                           ; preds = %NodeBlock13
  store i8 0, i8* @both, align 1
  br label %sw.epilog

sw.bb6:                                           ; preds = %NodeBlock11
...
if.end:                                           ; preds = %land.lhs.true, %sw.bb9
  ...
  br i1 %tobool12, label %cond.true, label %cond.end
...
cond.end:                                         ; preds = %if.end, %cond.true
  %cond = phi i64 [ %call13, %cond.true ], [ 1, %if.end ]
  store i64 %cond, i64* @col_sep_len, align 8
  br label %sw.epilog

sw.bb14:                                          ; preds = %NodeBlock3
  store i8 1, i8* @total_option, align 1
  br label %sw.epilog

sw.bb15:                                          ; preds = %NodeBlock1
  call void @usage(i32 0) #14
  unreachable

sw.bb16:                                          ; preds = %NodeBlock
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
if.end38:                                         ; preds = %if.end30
  ...
  %25 = load i8, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @issued_disorder_warning, i64 0, i64 0), align 1
  %tobool39 = trunc i8 %25 to i1
  br i1 %tobool39, label %if.then43, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %if.end38
  %26 = load i8, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @issued_disorder_warning, i64 0, i64 1), align 1
...
entry:
  ...
  %1 = call i8* @memset(i8* %0, i32 0, i64 24)
...
for.end:                                          ; preds = %for.cond1
  %arrayidx15 = getelementptr inbounds [2 x [3 x i32]], [2 x [3 x i32]]* %alt, i64 0, i64 %idxprom
...
if.end:                                           ; preds = %cond.end
  ...
  br i1 %tobool54, label %if.then55, label %for.inc61
...
while.cond:                                       ; preds = %for.cond154, %for.cond
  ...
  %46 = select i1 %tobool65, i1 true, i1 %tobool67
  br i1 %46, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %47 = bitcast [2 x i8]* %fill_up to i8*
  %48 = call i8* @memset(i8* %47, i32 0, i64 2)
  %arrayidx68 = getelementptr inbounds [2 x %struct.linebuffer*], [2 x %struct.linebuffer*]* %thisline, i64 0, i64 0
  %49 = load %struct.linebuffer*, %struct.linebuffer** %arrayidx68, align 16
  %tobool69 = icmp ne %struct.linebuffer* %49, null
...
if.else:                                          ; preds = %while.body
  ...
  %50 = load %struct.linebuffer*, %struct.linebuffer** %arrayidx71, align 8
  %tobool72 = icmp ne %struct.linebuffer* %50, null
...
if.else74:                                        ; preds = %if.else
  %51 = load i8, i8* @hard_LC_COLLATE, align 1
  ...
  %52 = load %struct.linebuffer*, %struct.linebuffer** %arrayidx77, align 16
  br i1 %tobool75, label %if.then76, label %if.else85

if.then76:                                        ; preds = %if.else74
  %buffer = getelementptr inbounds %struct.linebuffer, %struct.linebuffer* %52, i32 0, i32 2
  ...
  %54 = load %struct.linebuffer*, %struct.linebuffer** %arrayidx78, align 16
  %length = getelementptr inbounds %struct.linebuffer, %struct.linebuffer* %54, i32 0, i32 1
  ...
  %56 = load %struct.linebuffer*, %struct.linebuffer** %arrayidx79, align 8
  %buffer80 = getelementptr inbounds %struct.linebuffer, %struct.linebuffer* %56, i32 0, i32 2
  %57 = load i8*, i8** %buffer80, align 8
  %arrayidx81 = getelementptr inbounds [2 x %struct.linebuffer*], [2 x %struct.linebuffer*]* %thisline, i64 0, i64 1
  %58 = load %struct.linebuffer*, %struct.linebuffer** %arrayidx81, align 8
  %length82 = getelementptr inbounds %struct.linebuffer, %struct.linebuffer* %58, i32 0, i32 1
  %59 = load i64, i64* %length82, align 8
  %sub83 = sub i64 %59, 1
  %call84 = call i32 @xmemcoll(i8* %53, i64 %sub, i8* %57, i64 %sub83)
  store i32 %call84, i32* %order, align 4
  br label %if.end124

if.else85:                                        ; preds = %if.else74
  %length87 = getelementptr inbounds %struct.linebuffer, %struct.linebuffer* %52, i32 0, i32 1
...
if.then106:                                       ; preds = %cond.end97
  ...
  br i1 %cmp111, label %cond.end119, label %cond.false113
...
cond.end119:                                      ; preds = %if.then106, %cond.false113
  %cond120 = phi i32 [ %conv, %cond.false113 ], [ -1, %if.then106 ]
  store i32 %cond120, i32* %order, align 4
  br label %if.end124

if.end124:                                        ; preds = %if.then73, %cond.end97, %cond.end119, %if.then76, %if.then70
...
if.end143:                                        ; preds = %if.then134, %if.else138, %if.then127
...
for.cond154:                                      ; preds = %for.inc247, %if.end153
  ...
  br i1 %cmp155, label %for.body157, label %while.cond
...
for.body157:                                      ; preds = %for.cond154
  ...
  br i1 %tobool160, label %if.then161, label %for.inc247
...
if.else206:                                       ; preds = %if.then161
  %arrayidx211 = getelementptr inbounds [3 x i32], [3 x i32]* %arrayidx199, i64 0, i64 2
  %123 = load i32, i32* %arrayidx211, align 4
  %idxprom212 = sext i32 %123 to i64
  %arrayidx213 = getelementptr inbounds [4 x %struct.linebuffer*], [4 x %struct.linebuffer*]* %arrayidx197, i64 0, i64 %idxprom212
  %124 = load %struct.linebuffer*, %struct.linebuffer** %arrayidx213, align 8
  %buffer214 = getelementptr inbounds %struct.linebuffer, %struct.linebuffer* %124, i32 0, i32 2
  %125 = load i8*, i8** %buffer214, align 8
  %tobool215 = icmp ne i8* %125, null
  br i1 %tobool215, label %if.then216, label %if.end233
...
if.then216:                                       ; preds = %if.else206
  ...
  %128 = load i32, i32* %arrayidx221, align 4
  %idxprom222 = sext i32 %128 to i64
  %arrayidx223 = getelementptr inbounds [4 x %struct.linebuffer*], [4 x %struct.linebuffer*]* %arrayidx218, i64 0, i64 %idxprom222
  %129 = load %struct.linebuffer*, %struct.linebuffer** %arrayidx223, align 8
  ...
  %133 = load %struct.linebuffer*, %struct.linebuffer** %arrayidx230, align 8
  %134 = load i32, i32* %i, align 4
  %add231 = add nsw i32 %134, 1
  call void @check_order(%struct.linebuffer* %129, %struct.linebuffer* %133, i32 %add231)
  br label %if.end233

if.end233:                                        ; preds = %if.else206, %if.then216, %if.then195
  ...
  %136 = load %struct._IO_FILE*, %struct._IO_FILE** %arrayidx235, align 8
  %call236 = call i32 @ferror_unlocked(%struct._IO_FILE* %136) #11
...
if.then238:                                       ; preds = %if.end233
  ...
  %137 = load i32, i32* %call239, align 4
  %138 = load i8**, i8*** %infiles.addr, align 8
  %139 = load i32, i32* %i, align 4
  %idxprom240 = sext i32 %139 to i64
  %arrayidx241 = getelementptr inbounds i8*, i8** %138, i64 %idxprom240
  %140 = load i8*, i8** %arrayidx241, align 8
  %call242 = call i8* @quotearg_n_style_colon(i32 0, i32 3, i8* %140)
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %137, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.51, i64 0, i64 0), i8* %call242)
  unreachable
...
for.inc247:                                       ; preds = %for.body157, %if.end243
  %142 = load i32, i32* %i, align 4
  %inc248 = add nsw i32 %142, 1
...
for.cond250:                                      ; preds = %for.inc265, %while.end
  ...
  %cmp251 = icmp slt i32 %143, 2
  br i1 %cmp251, label %for.body253, label %for.end267

for.body253:                                      ; preds = %for.cond250
  %144 = load i32, i32* %i, align 4
  %idxprom254 = sext i32 %144 to i64
  %arrayidx255 = getelementptr inbounds [2 x %struct._IO_FILE*], [2 x %struct._IO_FILE*]* %streams, i64 0, i64 %idxprom254
  %145 = load %struct._IO_FILE*, %struct._IO_FILE** %arrayidx255, align 8
  %call256 = call i32 @rpl_fclose(%struct._IO_FILE* %145)
  %cmp257 = icmp ne i32 %call256, 0
  br i1 %cmp257, label %if.then259, label %for.inc265

if.then259:                                       ; preds = %for.body253
  %call260 = call i32* @__errno_location() #15
  %146 = load i32, i32* %call260, align 4
  %147 = load i8**, i8*** %infiles.addr, align 8
  %148 = load i32, i32* %i, align 4
  %idxprom261 = sext i32 %148 to i64
  %arrayidx262 = getelementptr inbounds i8*, i8** %147, i64 %idxprom261
  %149 = load i8*, i8** %arrayidx262, align 8
  %call263 = call i8* @quotearg_n_style_colon(i32 0, i32 3, i8* %149)
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %146, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.51, i64 0, i64 0), i8* %call263)
  unreachable

for.inc265:                                       ; preds = %for.body253
  %150 = load i32, i32* %i, align 4
  %inc266 = add nsw i32 %150, 1
  store i32 %inc266, i32* %i, align 4
  br label %for.cond250

for.end267:                                       ; preds = %for.cond250
  %151 = load i8, i8* @total_option, align 1
  %tobool268 = trunc i8 %151 to i1
...
if.then269:                                       ; preds = %for.end267
  ...
  %152 = load i64, i64* %arrayidx270, align 16
  %arraydecay = getelementptr inbounds [21 x i8], [21 x i8]* %buf1, i64 0, i64 0
  %call271 = call i8* @umaxtostr(i64 %152, i8* %arraydecay)
  %153 = load i8*, i8** @col_sep, align 8
  %arrayidx272 = getelementptr inbounds [3 x i64], [3 x i64]* %total, i64 0, i64 1
  %154 = load i64, i64* %arrayidx272, align 8
  %arraydecay273 = getelementptr inbounds [21 x i8], [21 x i8]* %buf2, i64 0, i64 0
  %call274 = call i8* @umaxtostr(i64 %154, i8* %arraydecay273)
  %155 = load i8*, i8** @col_sep, align 8
  %arrayidx275 = getelementptr inbounds [3 x i64], [3 x i64]* %total, i64 0, i64 2
  %156 = load i64, i64* %arrayidx275, align 16
  %arraydecay276 = getelementptr inbounds [21 x i8], [21 x i8]* %buf3, i64 0, i64 0
  %call277 = call i8* @umaxtostr(i64 %156, i8* %arraydecay276)
  %157 = load i8*, i8** @col_sep, align 8
  %158 = load i8, i8* @delim, align 1
  %conv278 = zext i8 %158 to i32
  %call279 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.52, i64 0, i64 0), i8* %call271, i8* %153, i8* %call274, i8* %155, i8* %call277, i8* %157, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.44, i64 0, i64 0), i32 %conv278)
  br label %if.end280
...
NodeBlock3:                                       ; preds = %entry
  %case.cmp4 = icmp eq i32 %0, 1
  br i1 %case.cmp4, label %sw.bb, label %NodeBlock1

NodeBlock1:                                       ; preds = %NodeBlock3
  %case.cmp2 = icmp eq i32 %0, 2
  br i1 %case.cmp2, label %sw.bb1, label %NodeBlock

NodeBlock:                                        ; preds = %NodeBlock1
  %case.cmp = icmp eq i32 %0, 3
...
if.end15:                                         ; preds = %if.then13, %if.end11
  ...
  br i1 %tobool16, label %if.then17, label %sw.epilog
...
sw.epilog:                                        ; preds = %newDefault, %if.end15, %if.then17, %if.end4, %if.then6, %sw.bb
...
return:                                           ; preds = %sw.bb8, %sw.bb1, %sw.bb, %sw.epilog
  ret void
}
...
if.else:                                          ; preds = %if.then3
  %call16 = call i32 @memcmp2(i8* %7, i64 %sub6, i8* %11, i64 %sub9) #13
  store i32 %call16, i32* %order, align 4
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then5
  %14 = load i32, i32* %order, align 4
  %cmp17 = icmp slt i32 0, %14
  br i1 %cmp17, label %if.then18, label %if.end25

if.then18:                                        ; preds = %if.end
  %15 = load i32, i32* @check_input_order, align 4
  %cmp19 = icmp eq i32 %15, 1
  %16 = zext i1 %cmp19 to i64
  %cond = select i1 %cmp19, i32 1, i32 0
  %17 = load i32, i32* %whatfile.addr, align 4
  call void (i32, i32, i8*, ...) @error(i32 %cond, i32 0, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.53, i64 0, i64 0), i32 %17)
  %18 = load i32, i32* %whatfile.addr, align 4
...
if.end25:                                         ; preds = %if.then, %if.then18, %if.end, %lor.lhs.false, %entry
  ret void
}
...
if.else:                                          ; preds = %if.then
  ...
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %4, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2.59, i64 0, i64 0), i8* %7)
  br label %if.end
...
do.body4:                                         ; preds = %entry, %do.body4
  ...
  br i1 %cmp10, label %do.body4, label %if.end

if.end:                                           ; preds = %do.body4, %do.end
...
if.end8:                                          ; preds = %if.then4, %if.then6, %if.else, %entry
...
if.else:                                          ; preds = %entry
  ...
  %call1 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1.115, i64 0, i64 0), i8* %5, i8* %6)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %7 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %7, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @version_etc_copyright, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2.116, i64 0, i64 0), i32 2020)
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call3 = call i32 @fputs_unlocked(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3.117, i64 0, i64 0), %struct._IO_FILE* %8)
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call4 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %9, i8* getelementptr inbounds ([171 x i8], [171 x i8]* @.str.4.118, i64 0, i64 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.5.119, i64 0, i64 0))
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call5 = call i32 @fputs_unlocked(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3.117, i64 0, i64 0), %struct._IO_FILE* %10)
...
sw.bb6:                                           ; preds = %NodeBlock15
  ...
  %call7 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %12, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.6.120, i64 0, i64 0), i8* %14)
  br label %sw.epilog
...
sw.bb8:                                           ; preds = %NodeBlock13
  ...
  %call11 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %15, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7.121, i64 0, i64 0), i8* %17, i8* %19)
  br label %sw.epilog
...
sw.bb12:                                          ; preds = %NodeBlock11
  ...
  %call16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %20, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.8.122, i64 0, i64 0), i8* %22, i8* %24, i8* %26)
  br label %sw.epilog
...
sw.bb17:                                          ; preds = %NodeBlock9
  ...
  %call22 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %27, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.9.123, i64 0, i64 0), i8* %29, i8* %31, i8* %33, i8* %35)
  br label %sw.epilog
...
sw.bb23:                                          ; preds = %NodeBlock7
  ...
  %call29 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %36, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.10.124, i64 0, i64 0), i8* %38, i8* %40, i8* %42, i8* %44, i8* %46)
  br label %sw.epilog
...
sw.bb30:                                          ; preds = %NodeBlock5
  ...
  %call37 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %47, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.11.125, i64 0, i64 0), i8* %49, i8* %51, i8* %53, i8* %55, i8* %57, i8* %59)
  br label %sw.epilog
...
sw.bb38:                                          ; preds = %NodeBlock3
  ...
  %call46 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %60, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.12.126, i64 0, i64 0), i8* %62, i8* %64, i8* %66, i8* %68, i8* %70, i8* %72, i8* %74)
  br label %sw.epilog
...
sw.bb47:                                          ; preds = %NodeBlock1
  ...
  %call56 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %75, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.13.127, i64 0, i64 0), i8* %77, i8* %79, i8* %81, i8* %83, i8* %85, i8* %87, i8* %89, i8* %91)
  br label %sw.epilog
...
sw.bb57:                                          ; preds = %NodeBlock
  ...
  %call67 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %92, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.14.128, i64 0, i64 0), i8* %94, i8* %96, i8* %98, i8* %100, i8* %102, i8* %104, i8* %106, i8* %108, i8* %110)
  br label %sw.epilog
...
sw.default:                                       ; preds = %newDefault
  ...
  %call77 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %111, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.15.129, i64 0, i64 0), i8* %113, i8* %115, i8* %117, i8* %119, i8* %121, i8* %123, i8* %125, i8* %127, i8* %129)
  br label %sw.epilog
...
entry:
  ...
  %cmp = icmp eq i8* %0, null
  %spec.store.select = select i1 %cmp, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.174, i64 0, i64 0), i8* %call
  ...
  %spec.store.select1 = select i1 %cmp1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1.175, i64 0, i64 0), i8* %spec.store.select
