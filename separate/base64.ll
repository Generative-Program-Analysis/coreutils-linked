...
if.else:                                          ; preds = %entry
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([70 x i8], [70 x i8]* @.str.2, i64 0, i64 0), i32 64)
...
land.rhs:                                         ; preds = %while.cond
  ...
  %call = call i32 @strcmp(i8* %4, i8* %6) #14
...
if.else29:                                        ; preds = %if.end26
  %29 = load %struct._IO_FILE*, %struct._IO_FILE** %input_fh, align 8
  %30 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %31 = load i64, i64* %wrap_column, align 8
  call void @do_encode(%struct._IO_FILE* %29, %struct._IO_FILE* %30, i64 %31)
  br label %if.end30

if.end30:                                         ; preds = %if.else29, %if.then27
  %32 = load %struct._IO_FILE*, %struct._IO_FILE** %input_fh, align 8
  %call31 = call i32 @rpl_fclose(%struct._IO_FILE* %32)
  %cmp32 = icmp eq i32 %call31, -1
  br i1 %cmp32, label %if.then33, label %if.end41

if.then33:                                        ; preds = %if.end30
  %33 = load i8*, i8** %infile, align 8
  %call34 = call i32 @strcmp(i8* %33, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.14, i64 0, i64 0)) #14
  %cmp35 = icmp eq i32 %call34, 0
  br i1 %cmp35, label %if.then36, label %if.else38

if.then36:                                        ; preds = %if.then33
  %call37 = call i32* @__errno_location() #16
  %34 = load i32, i32* %call37, align 4
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %34, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.17, i64 0, i64 0))
  unreachable

if.else38:                                        ; preds = %if.then33
  %call39 = call i32* @__errno_location() #16
  %35 = load i32, i32* %call39, align 4
  %36 = load i8*, i8** %infile, align 8
  %call40 = call i8* @quotearg_n_style_colon(i32 0, i32 3, i8* %36)
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %35, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.16, i64 0, i64 0), i8* %call40)
  unreachable
...
entry:
  ...
  %ctx = alloca %struct.base64_decode_context, align 4
  ...
  %call = call noalias i8* @xmalloc(i64 4096)
  store i8* %call, i8** %inbuf, align 8
  %call1 = call noalias i8* @xmalloc(i64 3072)
  store i8* %call1, i8** %outbuf, align 8
  call void @base64_decode_ctx_init(%struct.base64_decode_context* %ctx)
  br label %do.body
...
do.body2:                                         ; preds = %land.end29, %do.body
...
for.body:                                         ; preds = %land.end
  ...
  %call5 = call zeroext i1 @isbase64(i8 signext %12) #16
...
if.else:                                          ; preds = %lor.lhs.false
  ...
  call void @llvm.memmove.p0i8.p0i8.i64(i8* align 1 %add.ptr12, i8* align 1 %add.ptr15, i64 %sub16, i1 false)
  br label %if.end
...
if.end17:                                         ; preds = %for.end, %do.body2
  %26 = load i64, i64* %n, align 8
  %27 = load i64, i64* %sum, align 8
  %add18 = add i64 %27, %26
  store i64 %add18, i64* %sum, align 8
  %28 = load %struct._IO_FILE*, %struct._IO_FILE** %in.addr, align 8
  %call19 = call i32 @ferror_unlocked(%struct._IO_FILE* %28) #11
...
if.then21:                                        ; preds = %if.end17
  ...
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %29, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.41, i64 0, i64 0))
  unreachable
...
do.cond:                                          ; preds = %if.end23
  ...
  %cmp24 = icmp ult i64 %30, 4096
  br i1 %cmp24, label %land.rhs26, label %land.end29

land.rhs26:                                       ; preds = %do.cond
  %31 = load %struct._IO_FILE*, %struct._IO_FILE** %in.addr, align 8
  %call27 = call i32 @feof_unlocked(%struct._IO_FILE* %31) #11
  %tobool28 = icmp ne i32 %call27, 0
  %lnot = xor i1 %tobool28, true
  br label %land.end29

land.end29:                                       ; preds = %land.rhs26, %do.cond
  %32 = phi i1 [ false, %do.cond ], [ %lnot, %land.rhs26 ]
  br i1 %32, label %do.body2, label %do.end
...
land.lhs.true:                                    ; preds = %for.body38
  %i41 = getelementptr inbounds %struct.base64_decode_context, %struct.base64_decode_context* %ctx, i32 0, i32 0
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call48 = call zeroext i1 @base64_decode_ctx(%struct.base64_decode_context* %ctx, i8* %37, i64 %cond, i8* %40, i64* %n)
...
for.end60:                                        ; preds = %if.then44, %for.cond30
  br label %do.cond61

do.cond61:                                        ; preds = %for.end60
...
entry:
  ...
  store i8* %call, i8** %inbuf, align 8
  %call1 = call noalias i8* @xmalloc(i64 40960)
  store i8* %call1, i8** %outbuf, align 8
  br label %do.body

do.body:                                          ; preds = %land.end20, %entry
  store i64 0, i64* %sum, align 8
  br label %do.body2
...
land.end:                                         ; preds = %land.rhs, %land.lhs.true, %do.cond
  %9 = phi i1 [ false, %land.lhs.true ], [ false, %do.cond ], [ %cmp, %land.rhs ]
  br i1 %9, label %do.body2, label %do.end
...
if.then:                                          ; preds = %do.end
  ...
  %div = udiv i64 %add8, 3
  %mul = mul i64 %div, 4
  call void @base64_encode(i8* %11, i64 %12, i8* %13, i64 %mul)
  %15 = load i8*, i8** %outbuf, align 8
  %16 = load i64, i64* %sum, align 8
  %add9 = add i64 %16, 2
  %div10 = udiv i64 %add9, 3
  %mul11 = mul i64 %div10, 4
  %17 = load i64, i64* %wrap_column.addr, align 8
  %18 = load %struct._IO_FILE*, %struct._IO_FILE** %out.addr, align 8
  call void @wrap_write(i8* %15, i64 %mul11, i64 %17, i64* %current_column, %struct._IO_FILE* %18)
  br label %if.end
...
do.cond12:                                        ; preds = %if.end
  ...
  %call13 = call i32 @feof_unlocked(%struct._IO_FILE* %19) #11
  %tobool14 = icmp ne i32 %call13, 0
  br i1 %tobool14, label %land.end20, label %land.lhs.true15

land.lhs.true15:                                  ; preds = %do.cond12
  %20 = load %struct._IO_FILE*, %struct._IO_FILE** %in.addr, align 8
  %call16 = call i32 @ferror_unlocked(%struct._IO_FILE* %20) #11
  %tobool17 = icmp ne i32 %call16, 0
  br i1 %tobool17, label %land.end20, label %land.rhs18

land.rhs18:                                       ; preds = %land.lhs.true15
  %21 = load i64, i64* %sum, align 8
  %cmp19 = icmp eq i64 %21, 30720
  br label %land.end20

land.end20:                                       ; preds = %land.rhs18, %land.lhs.true15, %do.cond12
  %22 = phi i1 [ false, %land.lhs.true15 ], [ false, %do.cond12 ], [ %cmp19, %land.rhs18 ]
  br i1 %22, label %do.body, label %do.end21

do.end21:                                         ; preds = %land.end20
  %23 = load i64, i64* %wrap_column.addr, align 8
  %tobool22 = icmp ne i64 %23, 0
  br i1 %tobool22, label %land.lhs.true23, label %if.end30

land.lhs.true23:                                  ; preds = %do.end21
  %24 = load i64, i64* %current_column, align 8
  %cmp24 = icmp ugt i64 %24, 0
  br i1 %cmp24, label %land.lhs.true25, label %if.end30

land.lhs.true25:                                  ; preds = %land.lhs.true23
  %25 = load %struct._IO_FILE*, %struct._IO_FILE** %out.addr, align 8
  %call26 = call i32 @fputc_unlocked(i32 10, %struct._IO_FILE* %25)
...
if.then28:                                        ; preds = %land.lhs.true25
  ...
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %26, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.42, i64 0, i64 0))
  unreachable

if.end30:                                         ; preds = %land.lhs.true25, %land.lhs.true23, %do.end21
  %27 = load %struct._IO_FILE*, %struct._IO_FILE** %in.addr, align 8
  %call31 = call i32 @ferror_unlocked(%struct._IO_FILE* %27) #11
  %tobool32 = icmp ne i32 %call31, 0
...
if.then33:                                        ; preds = %if.end30
  ...
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %28, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.41, i64 0, i64 0))
  unreachable
...
cond.end11:                                       ; preds = %cond.false9, %cond.true8
  %cond12 = phi i64 [ %16, %cond.true8 ], [ %sub10, %cond.false9 ]
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @base64_encode(i8* noalias %in, i64 %inlen, i8* noalias %out, i64 %outlen) #2 {
entry:
...
if.then:                                          ; preds = %land.lhs.true
  ...
  call void @base64_encode_fast(i8* %3, i64 %4, i8* %5)
  br label %if.end81
...
while.body:                                       ; preds = %land.end
  ...
  %call = call zeroext i8 @to_uchar(i8 signext %10)
  %conv = zext i8 %call to i32
  %shr = ashr i32 %conv, 2
  %and = and i32 %shr, 63
  %idxprom = sext i32 %and to i64
  %arrayidx3 = getelementptr inbounds [64 x i8], [64 x i8]* @b64c, i64 0, i64 %idxprom
...
if.end6:                                          ; preds = %while.body
  ...
  %call8 = call zeroext i8 @to_uchar(i8 signext %15)
  %conv9 = zext i8 %call8 to i32
  %shl = shl i32 %conv9, 4
  %16 = load i64, i64* %inlen.addr, align 8
  %dec10 = add i64 %16, -1
  store i64 %dec10, i64* %inlen.addr, align 8
  %tobool11 = icmp ne i64 %dec10, 0
  br i1 %tobool11, label %cond.true, label %cond.false

cond.true:                                        ; preds = %if.end6
  %17 = load i8*, i8** %in.addr, align 8
  %arrayidx12 = getelementptr inbounds i8, i8* %17, i64 1
  %18 = load i8, i8* %arrayidx12, align 1
  %call13 = call zeroext i8 @to_uchar(i8 signext %18)
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %shr15, %cond.true ], [ 0, %cond.false ]
  %add = add nsw i32 %shl, %cond
  %and16 = and i32 %add, 63
  %idxprom17 = sext i32 %and16 to i64
  %arrayidx18 = getelementptr inbounds [64 x i8], [64 x i8]* @b64c, i64 0, i64 %idxprom17
  %19 = load i8, i8* %arrayidx18, align 1
  %20 = load i8*, i8** %out.addr, align 8
  %incdec.ptr19 = getelementptr inbounds i8, i8* %20, i32 1
  store i8* %incdec.ptr19, i8** %out.addr, align 8
  store i8 %19, i8* %20, align 1
  %21 = load i64, i64* %outlen.addr, align 8
  %dec20 = add i64 %21, -1
  store i64 %dec20, i64* %outlen.addr, align 8
  %tobool21 = icmp ne i64 %dec20, 0
...
if.end23:                                         ; preds = %cond.end
  ...
  br i1 %tobool24, label %cond.true25, label %cond.false45
...
if.end53:                                         ; preds = %cond.end46
  %31 = load i64, i64* %inlen.addr, align 8
  %tobool54 = icmp ne i64 %31, 0
  br i1 %tobool54, label %cond.true55, label %cond.false63

cond.true55:                                      ; preds = %if.end53
  %32 = load i8*, i8** %in.addr, align 8
  %arrayidx56 = getelementptr inbounds i8, i8* %32, i64 2
  %33 = load i8, i8* %arrayidx56, align 1
  %call57 = call zeroext i8 @to_uchar(i8 signext %33)
  %conv58 = zext i8 %call57 to i32
  %and59 = and i32 %conv58, 63
  %idxprom60 = sext i32 %and59 to i64
  %arrayidx61 = getelementptr inbounds [64 x i8], [64 x i8]* @b64c, i64 0, i64 %idxprom60
...
cond.end64:                                       ; preds = %cond.false63, %cond.true55
  %cond65 = phi i32 [ %conv62, %cond.true55 ], [ 61, %cond.false63 ]
  %conv66 = trunc i32 %cond65 to i8
  ...
  %36 = load i64, i64* %outlen.addr, align 8
  %dec68 = add i64 %36, -1
  store i64 %dec68, i64* %outlen.addr, align 8
...
while.end:                                        ; preds = %if.then70, %if.then52, %if.then22, %if.then5, %land.end
  %41 = load i64, i64* %outlen.addr, align 8
  %tobool79 = icmp ne i64 %41, 0
  br i1 %tobool79, label %if.then80, label %if.end81

if.then80:                                        ; preds = %while.end
  %42 = load i8*, i8** %out.addr, align 8
  store i8 0, i8* %42, align 1
  br label %if.end81

if.end81:                                         ; preds = %if.then, %if.then80, %while.end
  ret void
}

; Function Attrs: noinline nounwind uwtable
define internal void @base64_encode_fast(i8* noalias %in, i64 %inlen, i8* noalias %out) #2 {
entry:
  %in.addr = alloca i8*, align 8
  %inlen.addr = alloca i64, align 8
  %out.addr = alloca i8*, align 8
...
while.body:                                       ; preds = %while.cond
  ...
  %call = call zeroext i8 @to_uchar(i8 signext %2)
  %conv = zext i8 %call to i32
  %shr = ashr i32 %conv, 2
  %and = and i32 %shr, 63
  %idxprom = sext i32 %and to i64
  %arrayidx1 = getelementptr inbounds [64 x i8], [64 x i8]* @b64c, i64 0, i64 %idxprom
  ...
  %call3 = call zeroext i8 @to_uchar(i8 signext %6)
...
; Function Attrs: noinline nounwind uwtable
define dso_local i64 @base64_encode_alloc(i8* %in, i64 %inlen, i8** %out) #2 {
entry:
...
if.end3:                                          ; preds = %if.end
  ...
  call void @base64_encode(i8* %9, i64 %10, i8* %12, i64 %13)
...
define dso_local zeroext i1 @isbase64(i8 signext %ch) #8 {
entry:
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  %0 = load i8, i8* %ch.addr, align 1
  ...
  %arrayidx = getelementptr inbounds [256 x i8], [256 x i8]* @b64, i64 0, i64 %idxprom
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @base64_decode_ctx_init(%struct.base64_decode_context* %ctx) #2 {
entry:
  %ctx.addr = alloca %struct.base64_decode_context*, align 8
  store %struct.base64_decode_context* %ctx, %struct.base64_decode_context** %ctx.addr, align 8
  %0 = load %struct.base64_decode_context*, %struct.base64_decode_context** %ctx.addr, align 8
  %i = getelementptr inbounds %struct.base64_decode_context, %struct.base64_decode_context* %0, i32 0, i32 0
  store i32 0, i32* %i, align 4
  ret void
}

; Function Attrs: noinline nounwind uwtable
define dso_local zeroext i1 @base64_decode_ctx(%struct.base64_decode_context* %ctx, i8* noalias %in, i64 %inlen, i8* noalias %out, i64* %outlen) #2 {
entry:
  %ctx.addr = alloca %struct.base64_decode_context*, align 8
  %in.addr = alloca i8*, align 8
  %inlen.addr = alloca i64, align 8
  ...
  %2 = load %struct.base64_decode_context*, %struct.base64_decode_context** %ctx.addr, align 8
  %cmp = icmp ne %struct.base64_decode_context* %2, null
...
if.then:                                          ; preds = %entry
  %4 = load %struct.base64_decode_context*, %struct.base64_decode_context** %ctx.addr, align 8
  %i = getelementptr inbounds %struct.base64_decode_context, %struct.base64_decode_context* %4, i32 0, i32 0
...
if.end10:                                         ; preds = %while.end, %land.lhs.true, %while.body
...
if.then29:                                        ; preds = %if.end24
  %30 = load %struct.base64_decode_context*, %struct.base64_decode_context** %ctx.addr, align 8
  %31 = load i8*, i8** %in_end, align 8
  %call30 = call i8* @get_4(%struct.base64_decode_context* %30, i8** %in.addr, i8* %31, i64* %inlen.addr)
...
if.end42:                                         ; preds = %land.lhs.true38, %land.lhs.true36, %lor.lhs.false
  ...
  %38 = load i64, i64* %inlen.addr, align 8
  %call43 = call zeroext i1 @decode_4(i8* %37, i64 %38, i8** %out.addr, i64* %outleft)
...
while.end46:                                      ; preds = %if.then44, %if.then41, %if.then14
...
; Function Attrs: noinline nounwind uwtable
define internal zeroext i1 @decode_4(i8* noalias %in, i64 %inlen, i8** %outp, i64* %outleft) #2 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call = call zeroext i1 @isbase64(i8 signext %4) #16
...
lor.lhs.false:                                    ; preds = %if.end
  ...
  %call2 = call zeroext i1 @isbase64(i8 signext %6) #16
...
if.then5:                                         ; preds = %if.end4
  ...
  %arrayidx8 = getelementptr inbounds [256 x i8], [256 x i8]* @b64, i64 0, i64 %idxprom
  ...
  %arrayidx12 = getelementptr inbounds [256 x i8], [256 x i8]* @b64, i64 0, i64 %idxprom11
...
do.body:                                          ; preds = %if.then18
  ...
  %20 = load i8**, i8*** %outp.addr, align 8
...
if.end19:                                         ; preds = %do.end, %if.end15
  %21 = load i8*, i8** %in.addr, align 8
  %arrayidx20 = getelementptr inbounds i8, i8* %21, i64 2
...
if.then24:                                        ; preds = %if.end19
  %23 = load i64, i64* %inlen.addr, align 8
  %cmp25 = icmp ne i64 %23, 4
...
do.body28:                                        ; preds = %if.then27
  ...
  %25 = load i8**, i8*** %outp.addr, align 8
...
if.end30:                                         ; preds = %do.end29, %if.then24
  %26 = load i8*, i8** %in.addr, align 8
  %arrayidx31 = getelementptr inbounds i8, i8* %26, i64 3
...
do.body36:                                        ; preds = %if.then35
  ...
  %29 = load i8**, i8*** %outp.addr, align 8
...
if.end38:                                         ; preds = %do.end37, %if.end30
  br label %if.end108

if.else:                                          ; preds = %if.end19
  %30 = load i8*, i8** %in.addr, align 8
  %arrayidx39 = getelementptr inbounds i8, i8* %30, i64 2
  %31 = load i8, i8* %arrayidx39, align 1
  %call40 = call zeroext i1 @isbase64(i8 signext %31) #16
...
do.body42:                                        ; preds = %if.then41
  ...
  %33 = load i8**, i8*** %outp.addr, align 8
...
if.end44:                                         ; preds = %do.end43, %if.else
  %34 = load i64*, i64** %outleft.addr, align 8
...
if.then46:                                        ; preds = %if.end44
  ...
  %arrayidx47 = getelementptr inbounds i8, i8* %36, i64 1
  %37 = load i8, i8* %arrayidx47, align 1
  %call48 = call zeroext i8 @to_uchar(i8 signext %37)
  %idxprom49 = zext i8 %call48 to i64
  %arrayidx50 = getelementptr inbounds [256 x i8], [256 x i8]* @b64, i64 0, i64 %idxprom49
  %38 = load i8, i8* %arrayidx50, align 1
  %conv51 = sext i8 %38 to i32
  %shl52 = shl i32 %conv51, 4
  %and = and i32 %shl52, 240
  %39 = load i8*, i8** %in.addr, align 8
  %arrayidx53 = getelementptr inbounds i8, i8* %39, i64 2
  %40 = load i8, i8* %arrayidx53, align 1
  %call54 = call zeroext i8 @to_uchar(i8 signext %40)
  %idxprom55 = zext i8 %call54 to i64
  %arrayidx56 = getelementptr inbounds [256 x i8], [256 x i8]* @b64, i64 0, i64 %idxprom55
  %41 = load i8, i8* %arrayidx56, align 1
  %conv57 = sext i8 %41 to i32
  %shr58 = ashr i32 %conv57, 2
  %or59 = or i32 %and, %shr58
  %conv60 = trunc i32 %or59 to i8
  %42 = load i8*, i8** %out, align 8
  %incdec.ptr61 = getelementptr inbounds i8, i8* %42, i32 1
  store i8* %incdec.ptr61, i8** %out, align 8
  store i8 %conv60, i8* %42, align 1
  %43 = load i64*, i64** %outleft.addr, align 8
  %44 = load i64, i64* %43, align 8
  %dec62 = add i64 %44, -1
  store i64 %dec62, i64* %43, align 8
  br label %if.end63

if.end63:                                         ; preds = %if.then46, %if.end44
...
do.body67:                                        ; preds = %if.then66
  ...
  %47 = load i8**, i8*** %outp.addr, align 8
...
if.end69:                                         ; preds = %do.end68, %if.end63
  %48 = load i8*, i8** %in.addr, align 8
  %arrayidx70 = getelementptr inbounds i8, i8* %48, i64 3
...
if.then74:                                        ; preds = %if.end69
  %50 = load i64, i64* %inlen.addr, align 8
  %cmp75 = icmp ne i64 %50, 4
...
do.body78:                                        ; preds = %if.then77
  %51 = load i8*, i8** %out, align 8
  %52 = load i8**, i8*** %outp.addr, align 8
...
if.end80:                                         ; preds = %do.end79, %if.then74
  br label %if.end107
...
if.else81:                                        ; preds = %if.end69
  ...
  %call83 = call zeroext i1 @isbase64(i8 signext %54) #16
...
do.body85:                                        ; preds = %if.then84
  ...
  %56 = load i8**, i8*** %outp.addr, align 8
...
if.end87:                                         ; preds = %do.end86, %if.else81
  %57 = load i64*, i64** %outleft.addr, align 8
  %58 = load i64, i64* %57, align 8
  %tobool88 = icmp ne i64 %58, 0
  br i1 %tobool88, label %if.then89, label %if.end106

if.then89:                                        ; preds = %if.end87
  %59 = load i8*, i8** %in.addr, align 8
  %arrayidx90 = getelementptr inbounds i8, i8* %59, i64 2
  %60 = load i8, i8* %arrayidx90, align 1
  %call91 = call zeroext i8 @to_uchar(i8 signext %60)
  %idxprom92 = zext i8 %call91 to i64
  %arrayidx93 = getelementptr inbounds [256 x i8], [256 x i8]* @b64, i64 0, i64 %idxprom92
  %61 = load i8, i8* %arrayidx93, align 1
  %conv94 = sext i8 %61 to i32
  %shl95 = shl i32 %conv94, 6
  %and96 = and i32 %shl95, 192
  %62 = load i8*, i8** %in.addr, align 8
  %arrayidx97 = getelementptr inbounds i8, i8* %62, i64 3
  %63 = load i8, i8* %arrayidx97, align 1
  %call98 = call zeroext i8 @to_uchar(i8 signext %63)
  %idxprom99 = zext i8 %call98 to i64
  %arrayidx100 = getelementptr inbounds [256 x i8], [256 x i8]* @b64, i64 0, i64 %idxprom99
  %64 = load i8, i8* %arrayidx100, align 1
  %conv101 = sext i8 %64 to i32
  %or102 = or i32 %and96, %conv101
  %conv103 = trunc i32 %or102 to i8
  %65 = load i8*, i8** %out, align 8
  %incdec.ptr104 = getelementptr inbounds i8, i8* %65, i32 1
  store i8* %incdec.ptr104, i8** %out, align 8
  store i8 %conv103, i8* %65, align 1
  %66 = load i64*, i64** %outleft.addr, align 8
  %67 = load i64, i64* %66, align 8
  %dec105 = add i64 %67, -1
  store i64 %dec105, i64* %66, align 8
  br label %if.end106

if.end106:                                        ; preds = %if.then89, %if.end87
  br label %if.end107
...
if.end108:                                        ; preds = %if.end107, %if.end38
  %68 = load i8*, i8** %out, align 8
  %69 = load i8**, i8*** %outp.addr, align 8
  store i8* %68, i8** %69, align 8
  store i1 true, i1* %retval, align 1
  br label %return

return:                                           ; preds = %if.end108, %do.body85, %do.body78, %do.body67, %do.body42, %do.body36, %do.body28, %do.body, %if.then3, %if.then
  %70 = load i1, i1* %retval, align 1
  ret i1 %70
}

; Function Attrs: noinline nounwind uwtable
define internal i8* @get_4(%struct.base64_decode_context* %ctx, i8** %in, i8* noalias %in_end, i64* %n_non_newline) #2 {
entry:
...
if.then:                                          ; preds = %entry
  %2 = load %struct.base64_decode_context*, %struct.base64_decode_context** %ctx.addr, align 8
  %i1 = getelementptr inbounds %struct.base64_decode_context, %struct.base64_decode_context* %2, i32 0, i32 0
  store i32 0, i32* %i1, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load %struct.base64_decode_context*, %struct.base64_decode_context** %ctx.addr, align 8
  %i2 = getelementptr inbounds %struct.base64_decode_context, %struct.base64_decode_context* %3, i32 0, i32 0
...
if.then4:                                         ; preds = %if.end
  ...
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %cmp5 = icmp sle i64 4, %sub.ptr.sub
  br i1 %cmp5, label %land.lhs.true, label %if.end8

land.lhs.true:                                    ; preds = %if.then4
  %10 = load i8*, i8** %t, align 8
  %call = call i8* @memchr(i8* %10, i32 10, i64 4) #14
...
if.then13:                                        ; preds = %while.body
  ...
  %23 = load %struct.base64_decode_context*, %struct.base64_decode_context** %ctx.addr, align 8
  %buf = getelementptr inbounds %struct.base64_decode_context, %struct.base64_decode_context* %23, i32 0, i32 1
  %24 = load %struct.base64_decode_context*, %struct.base64_decode_context** %ctx.addr, align 8
  %i14 = getelementptr inbounds %struct.base64_decode_context, %struct.base64_decode_context* %24, i32 0, i32 0
  ...
  %26 = load %struct.base64_decode_context*, %struct.base64_decode_context** %ctx.addr, align 8
  %i15 = getelementptr inbounds %struct.base64_decode_context, %struct.base64_decode_context* %26, i32 0, i32 0
...
while.end:                                        ; preds = %if.then18, %while.cond
  ...
  store i8* %28, i8** %29, align 8
  %30 = load %struct.base64_decode_context*, %struct.base64_decode_context** %ctx.addr, align 8
  %i21 = getelementptr inbounds %struct.base64_decode_context, %struct.base64_decode_context* %30, i32 0, i32 0
  ...
  %33 = load %struct.base64_decode_context*, %struct.base64_decode_context** %ctx.addr, align 8
  %buf23 = getelementptr inbounds %struct.base64_decode_context, %struct.base64_decode_context* %33, i32 0, i32 1
  %arraydecay = getelementptr inbounds [4 x i8], [4 x i8]* %buf23, i64 0, i64 0
...
; Function Attrs: noinline nounwind uwtable
define dso_local zeroext i1 @base64_decode_alloc_ctx(%struct.base64_decode_context* %ctx, i8* %in, i64 %inlen, i8** %out, i64* %outlen) #2 {
entry:
  %retval = alloca i1, align 1
  %ctx.addr = alloca %struct.base64_decode_context*, align 8
  %in.addr = alloca i8*, align 8
...
if.end:                                           ; preds = %entry
  %5 = load %struct.base64_decode_context*, %struct.base64_decode_context** %ctx.addr, align 8
  %6 = load i8*, i8** %in.addr, align 8
  %7 = load i64, i64* %inlen.addr, align 8
  %8 = load i8**, i8*** %out.addr, align 8
  %9 = load i8*, i8** %8, align 8
  %call1 = call zeroext i1 @base64_decode_ctx(%struct.base64_decode_context* %5, i8* %6, i64 %7, i8* %9, i64* %needlen)
...
if.else:                                          ; preds = %if.then
  %call8 = call i32* @__errno_location() #16
  %7 = load i32, i32* %call8, align 4
  %8 = load i8*, i8** %write_error, align 8
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %7, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2.57, i64 0, i64 0), i8* %8)
  br label %if.end
...
if.then349:                                       ; preds = %if.else346
  ...
  %call350 = call i64 @strlen(i8* %179) #14
...
if.else:                                          ; preds = %entry
  ...
  %call1 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1.95, i64 0, i64 0), i8* %6, i8* %7)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %8, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @version_etc_copyright, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2.96, i64 0, i64 0), i32 2020)
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call3 = call i32 @fputs_unlocked(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3.97, i64 0, i64 0), %struct._IO_FILE* %9)
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call4 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %10, i8* getelementptr inbounds ([171 x i8], [171 x i8]* @.str.4.98, i64 0, i64 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.5.99, i64 0, i64 0))
  %11 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call5 = call i32 @fputs_unlocked(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3.97, i64 0, i64 0), %struct._IO_FILE* %11)
...
sw.bb6:                                           ; preds = %if.end
  ...
  %call7 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %13, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.6.100, i64 0, i64 0), i8* %15)
  br label %sw.epilog
...
sw.bb8:                                           ; preds = %if.end
  ...
  %call11 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %16, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7.101, i64 0, i64 0), i8* %18, i8* %20)
  br label %sw.epilog
...
sw.bb12:                                          ; preds = %if.end
  ...
  %call16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %21, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.8.102, i64 0, i64 0), i8* %23, i8* %25, i8* %27)
  br label %sw.epilog
...
sw.bb17:                                          ; preds = %if.end
  ...
  %call22 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %28, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.9.103, i64 0, i64 0), i8* %30, i8* %32, i8* %34, i8* %36)
  br label %sw.epilog
...
sw.bb23:                                          ; preds = %if.end
  ...
  %call29 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %37, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.10.104, i64 0, i64 0), i8* %39, i8* %41, i8* %43, i8* %45, i8* %47)
  br label %sw.epilog
...
sw.bb30:                                          ; preds = %if.end
  ...
  %call37 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.11.105, i64 0, i64 0), i8* %50, i8* %52, i8* %54, i8* %56, i8* %58, i8* %60)
  br label %sw.epilog
...
sw.bb38:                                          ; preds = %if.end
  ...
  %call46 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %61, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.12.106, i64 0, i64 0), i8* %63, i8* %65, i8* %67, i8* %69, i8* %71, i8* %73, i8* %75)
  br label %sw.epilog
...
sw.bb47:                                          ; preds = %if.end
  ...
  %call56 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %76, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.13.107, i64 0, i64 0), i8* %78, i8* %80, i8* %82, i8* %84, i8* %86, i8* %88, i8* %90, i8* %92)
  br label %sw.epilog
...
sw.bb57:                                          ; preds = %if.end
  ...
  %call67 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %93, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.14.108, i64 0, i64 0), i8* %95, i8* %97, i8* %99, i8* %101, i8* %103, i8* %105, i8* %107, i8* %109, i8* %111)
  br label %sw.epilog
...
sw.default:                                       ; preds = %if.end
  ...
  %call77 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %112, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.15.109, i64 0, i64 0), i8* %114, i8* %116, i8* %118, i8* %120, i8* %122, i8* %124, i8* %126, i8* %128, i8* %130)
  br label %sw.epilog
...
if.else:                                          ; preds = %if.then3
  %call7 = call i32* @__errno_location() #16
...
cond.end27:                                       ; preds = %cond.false25, %cond.true24
  %cond28 = phi i32 [ 0, %cond.true24 ], [ %15, %cond.false25 ]
...
if.then:                                          ; preds = %entry
  store i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.162, i64 0, i64 0), i8** %codeset, align 8
  br label %if.end
...
if.then3:                                         ; preds = %if.end
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1.163, i64 0, i64 0), i8** %codeset, align 8
  br label %if.end4
