...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i64 [ 1, %cond.true ], [ %call28, %cond.false ]
...
sw.epilog:                                        ; preds = %sw.bb33, %sw.bb32, %sw.bb31, %sw.bb30, %cond.end, %if.end21, %if.end9, %if.end
  br label %while.cond
...
if.end41:                                         ; preds = %do.end40, %while.end
  %22 = load i8, i8* %delim_specified, align 1
  %tobool = trunc i8 %22 to i1
  br i1 %tobool, label %land.lhs.true43, label %if.end49
...
if.end49:                                         ; preds = %do.end48, %land.lhs.true43, %if.end41
...
if.end58:                                         ; preds = %do.end57, %land.lhs.true52, %if.end49
...
if.else15:                                        ; preds = %if.end11
  ...
  %call16 = call i32 @rpl_fclose(%struct._IO_FILE* %13)
...
if.then18:                                        ; preds = %if.else15
  ...
  %call20 = call i8* @quotearg_n_style_colon(i32 0, i32 3, i8* %15)
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %14, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.54, i64 0, i64 0), i8* %call20)
  store i1 false, i1* %retval, align 1
  br label %return
...
if.else:                                          ; preds = %entry
  ...
  call void @cut_fields(%struct._IO_FILE* %2)
  br label %if.end
...
if.then5:                                         ; preds = %if.else
  %7 = load i64, i64* %byte_idx, align 8
  %cmp6 = icmp ugt i64 %7, 0
  br i1 %cmp6, label %if.then8, label %if.end

if.then8:                                         ; preds = %if.then5
  %8 = load i8, i8* @line_delim, align 1
...
if.else11:                                        ; preds = %if.else
  ...
  %9 = load i64, i64* %byte_idx, align 8
  %call12 = call zeroext i1 @print_kth(i64 %9)
  br i1 %call12, label %if.then13, label %if.end24

if.then13:                                        ; preds = %if.else11
  %10 = load i8, i8* @output_delimiter_specified, align 1
  %tobool = trunc i8 %10 to i1
  br i1 %tobool, label %if.then14, label %if.end22

if.then14:                                        ; preds = %if.then13
  %11 = load i8, i8* %print_delimiter, align 1
  %tobool15 = trunc i8 %11 to i1
  br i1 %tobool15, label %land.lhs.true, label %if.end21

land.lhs.true:                                    ; preds = %if.then14
  %12 = load i64, i64* %byte_idx, align 8
  %call17 = call zeroext i1 @is_range_start_index(i64 %12)
  br i1 %call17, label %if.then19, label %if.end21

if.then19:                                        ; preds = %land.lhs.true
  %13 = load i8*, i8** @output_delimiter_string, align 8
  %14 = load i64, i64* @output_delimiter_length, align 8
  %15 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call20 = call i64 @fwrite_unlocked(i8* %13, i64 1, i64 %14, %struct._IO_FILE* %15)
  br label %if.end21
...
if.end22:                                         ; preds = %if.end21, %if.then13
  ...
  %call23 = call i32 @putchar_unlocked(i32 %16)
  br label %if.end24

if.end24:                                         ; preds = %if.end22, %if.else11
  br label %if.end25
...
if.end47:                                         ; preds = %if.end45, %if.then33
  br label %while.body
...
if.end67:                                         ; preds = %if.end66, %land.lhs.true, %while.body
  ...
  br i1 %call68, label %if.then69, label %if.else87
...
land.rhs:                                         ; preds = %land.lhs.true79
  %50 = load i32, i32* %c, align 4
  %cmp83 = icmp ne i32 %50, -1
  br label %land.end

land.end:                                         ; preds = %land.rhs, %land.lhs.true79, %while.cond74
  %51 = phi i1 [ false, %land.lhs.true79 ], [ false, %while.cond74 ], [ %cmp83, %land.rhs ]
  br i1 %51, label %while.body85, label %while.end

while.body85:                                     ; preds = %land.end
  %52 = load i32, i32* %c, align 4
  %call86 = call i32 @putchar_unlocked(i32 %52)
  %53 = load i32, i32* %c, align 4
  store i32 %53, i32* %prev_c, align 4
  br label %while.cond74

while.end:                                        ; preds = %land.end
  br label %if.end103

if.else87:                                        ; preds = %if.end67
  br label %while.cond88

while.cond88:                                     ; preds = %while.body101, %if.else87
  %54 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call89 = call i32 @getc_unlocked(%struct._IO_FILE* %54)
  store i32 %call89, i32* %c, align 4
  %55 = load i8, i8* @delim, align 1
  %conv90 = zext i8 %55 to i32
  %cmp91 = icmp ne i32 %call89, %conv90
  br i1 %cmp91, label %land.lhs.true93, label %land.end100

land.lhs.true93:                                  ; preds = %while.cond88
  %56 = load i32, i32* %c, align 4
  %57 = load i8, i8* @line_delim, align 1
  %conv94 = zext i8 %57 to i32
  %cmp95 = icmp ne i32 %56, %conv94
  br i1 %cmp95, label %land.rhs97, label %land.end100

land.rhs97:                                       ; preds = %land.lhs.true93
  %58 = load i32, i32* %c, align 4
  %cmp98 = icmp ne i32 %58, -1
  br label %land.end100

land.end100:                                      ; preds = %land.rhs97, %land.lhs.true93, %while.cond88
  %59 = phi i1 [ false, %land.lhs.true93 ], [ false, %while.cond88 ], [ %cmp98, %land.rhs97 ]
  br i1 %59, label %while.body101, label %while.end102

while.body101:                                    ; preds = %land.end100
  %60 = load i32, i32* %c, align 4
  store i32 %60, i32* %prev_c, align 4
  br label %while.cond88

while.end102:                                     ; preds = %land.end100
  br label %if.end103

if.end103:                                        ; preds = %while.end102, %while.end
  %61 = load i8, i8* @delim, align 1
  %conv104 = zext i8 %61 to i32
  %62 = load i8, i8* @line_delim, align 1
...
if.then112:                                       ; preds = %land.lhs.true108
  ...
  %call114 = call i32 @getc_unlocked(%struct._IO_FILE* %65)
  store i32 %call114, i32* %last_c113, align 4
  %66 = load i32, i32* %last_c113, align 4
  %cmp115 = icmp ne i32 %66, -1
  br i1 %cmp115, label %if.then117, label %if.else119

if.then117:                                       ; preds = %if.then112
  %67 = load i32, i32* %last_c113, align 4
  %68 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call118 = call i32 @ungetc(i32 %67, %struct._IO_FILE* %68)
  br label %if.end120

if.else119:                                       ; preds = %if.then112
  %69 = load i32, i32* %last_c113, align 4
...
if.end121:                                        ; preds = %if.end120, %land.lhs.true108, %if.end103
  %70 = load i32, i32* %c, align 4
  %71 = load i8, i8* @delim, align 1
  %conv122 = zext i8 %71 to i32
  %cmp123 = icmp eq i32 %70, %conv122
...
if.then155:                                       ; preds = %lor.lhs.false150, %lor.lhs.false146, %if.then142
  %84 = load i8, i8* @line_delim, align 1
  %conv156 = zext i8 %84 to i32
  %call157 = call i32 @putchar_unlocked(i32 %conv156)
  br label %if.end158

if.end158:                                        ; preds = %if.then155, %lor.lhs.false150
  br label %if.end159

if.end159:                                        ; preds = %if.end158, %land.lhs.true139
  %85 = load i32, i32* %c, align 4
  %cmp160 = icmp eq i32 %85, -1
...
if.end163:                                        ; preds = %if.end159
  store i64 1, i64* %field_idx, align 8
  %86 = load %struct.field_range_pair*, %struct.field_range_pair** @frp, align 8
  store %struct.field_range_pair* %86, %struct.field_range_pair** @current_rp, align 8
  store i8 0, i8* %found_any_selected_field, align 1
  br label %if.end164

if.end164:                                        ; preds = %if.end163, %lor.lhs.false130
  br label %if.end165

if.end165:                                        ; preds = %if.end164, %if.then125
  br label %while.body

while.end166:                                     ; preds = %if.then, %if.then162, %if.then19
  ret void
}
...
if.end8:                                          ; preds = %do.end, %if.then3
  ...
  br i1 %tobool10, label %land.lhs.true12, label %if.end20
...
if.end20:                                         ; preds = %do.end19, %land.lhs.true12, %if.end8
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond23 = phi i64 [ %14, %cond.true ], [ 1, %cond.false ]
...
if.end50:                                         ; preds = %do.end49, %if.then46
  br label %if.end51

if.end51:                                         ; preds = %if.end50, %land.lhs.true41, %if.then39
...
if.end60:                                         ; preds = %do.end59, %if.else54
...
if.end71:                                         ; preds = %do.end70, %if.else62
...
if.end92:                                         ; preds = %if.else91, %if.then90
  ...
  br i1 %cmp95, label %cond.true103, label %lor.lhs.false97
...
cond.true103:                                     ; preds = %lor.lhs.false97, %if.end92
...
if.end131:                                        ; preds = %if.end130, %if.end77
  br label %if.end132

if.end132:                                        ; preds = %if.end131, %cond.end
  br label %while.body

while.end:                                        ; preds = %if.then76
  %67 = load i64, i64* @n_frp, align 8
  %tobool133 = icmp ne i64 %67, 0
  br i1 %tobool133, label %if.end140, label %if.then134
...
if.end140:                                        ; preds = %do.end139, %while.end
...
for.body147:                                      ; preds = %for.cond144
  ...
  br i1 %cmp150, label %if.then152, label %if.else175
...
cond.false162:                                    ; preds = %if.then152
  %93 = load %struct.field_range_pair*, %struct.field_range_pair** @frp, align 8
  %94 = load i64, i64* %i, align 8
  %arrayidx163 = getelementptr inbounds %struct.field_range_pair, %struct.field_range_pair* %93, i64 %94
  %hi164 = getelementptr inbounds %struct.field_range_pair, %struct.field_range_pair* %arrayidx163, i32 0, i32 1
  %95 = load i64, i64* %hi164, align 8
  br label %cond.end165

cond.end165:                                      ; preds = %cond.false162, %cond.true159
  %cond166 = phi i64 [ %92, %cond.true159 ], [ %95, %cond.false162 ]
  %96 = load %struct.field_range_pair*, %struct.field_range_pair** @frp, align 8
  %97 = load i64, i64* %i, align 8
  %arrayidx167 = getelementptr inbounds %struct.field_range_pair, %struct.field_range_pair* %96, i64 %97
  ...
  %98 = load %struct.field_range_pair*, %struct.field_range_pair** @frp, align 8
  %99 = load i64, i64* %j, align 8
  %add.ptr = getelementptr inbounds %struct.field_range_pair, %struct.field_range_pair* %98, i64 %99
  %100 = bitcast %struct.field_range_pair* %add.ptr to i8*
  %101 = load %struct.field_range_pair*, %struct.field_range_pair** @frp, align 8
  %102 = load i64, i64* %j, align 8
  %add.ptr169 = getelementptr inbounds %struct.field_range_pair, %struct.field_range_pair* %101, i64 %102
  %add.ptr170 = getelementptr inbounds %struct.field_range_pair, %struct.field_range_pair* %add.ptr169, i64 1
  %103 = bitcast %struct.field_range_pair* %add.ptr170 to i8*
  %104 = load i64, i64* @n_frp, align 8
  %105 = load i64, i64* %j, align 8
  %sub171 = sub i64 %104, %105
  %sub172 = sub i64 %sub171, 1
  %mul173 = mul i64 %sub172, 16
  call void @llvm.memmove.p0i8.p0i8.i64(i8* align 8 %100, i8* align 8 %103, i64 %mul173, i1 false)
...
if.else175:                                       ; preds = %for.body147
  br label %for.end

if.end176:                                        ; preds = %cond.end165
  br label %for.inc
...
for.end:                                          ; preds = %if.else175, %for.cond144
  br label %for.inc177
...
for.end:                                          ; preds = %for.cond
  %21 = load %struct.field_range_pair*, %struct.field_range_pair** %c, align 8
  %22 = load i64, i64* %n, align 8
  %sub18 = sub i64 %22, 1
  %arrayidx19 = getelementptr inbounds %struct.field_range_pair, %struct.field_range_pair* %21, i64 %sub18
  %hi20 = getelementptr inbounds %struct.field_range_pair, %struct.field_range_pair* %arrayidx19, i32 0, i32 1
  %23 = load i64, i64* %hi20, align 8
  %cmp21 = icmp ult i64 %23, -1
  br i1 %cmp21, label %if.then22, label %if.end27

if.then22:                                        ; preds = %for.end
  %24 = load %struct.field_range_pair*, %struct.field_range_pair** %c, align 8
  %25 = load i64, i64* %n, align 8
  %sub23 = sub i64 %25, 1
  %arrayidx24 = getelementptr inbounds %struct.field_range_pair, %struct.field_range_pair* %24, i64 %sub23
  %hi25 = getelementptr inbounds %struct.field_range_pair, %struct.field_range_pair* %arrayidx24, i32 0, i32 1
  %26 = load i64, i64* %hi25, align 8
  %add26 = add i64 %26, 1
  call void @add_range_pair(i64 %add26, i64 -1)
  br label %if.end27

if.end27:                                         ; preds = %if.then22, %for.end
  %27 = load %struct.field_range_pair*, %struct.field_range_pair** %c, align 8
  %28 = bitcast %struct.field_range_pair* %27 to i8*
...
if.else:                                          ; preds = %if.then
  ...
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %7, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2.79, i64 0, i64 0), i8* %8)
  br label %if.end
...
if.else:                                          ; preds = %if.end10
  %20 = load i32, i32* %delim2.addr, align 4
  %cmp13 = icmp eq i32 %20, -1
  br i1 %cmp13, label %if.then14, label %if.end15

if.then14:                                        ; preds = %if.else
  %21 = load i32, i32* %delim1.addr, align 4
  store i32 %21, i32* %delim2.addr, align 4
  br label %if.end15
...
do.body:                                          ; preds = %do.cond, %if.end16
  ...
  %call17 = call i8* @freadptr(%struct._IO_FILE* %22, i64* %buffer_len)
...
if.then19:                                        ; preds = %do.body
  %24 = load i32, i32* %delim1.addr, align 4
  %cmp20 = icmp ne i32 %24, -1
  br i1 %cmp20, label %if.then21, label %if.end26

if.then21:                                        ; preds = %if.then19
  %25 = load i8*, i8** %buffer, align 8
  %26 = load i32, i32* %delim1.addr, align 4
  %27 = load i32, i32* %delim2.addr, align 4
  %28 = load i64, i64* %buffer_len, align 8
  %call22 = call i8* @memchr2(i8* %25, i32 %26, i32 %27, i64 %28) #13
...
if.else27:                                        ; preds = %do.body
  ...
  %call28 = call i32 @getc_unlocked(%struct._IO_FILE* %32)
...
if.then30:                                        ; preds = %if.else27
  %34 = load i8*, i8** %read_pos, align 8
...
if.end34:                                         ; preds = %if.else27
  ...
  %37 = load i32, i32* %delim1.addr, align 4
  %cmp35 = icmp eq i32 %36, %37
  br i1 %cmp35, label %if.then37, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %if.end34
  %38 = load i32, i32* %c, align 4
  %39 = load i32, i32* %delim2.addr, align 4
  %cmp36 = icmp eq i32 %38, %39
...
cond.end49:                                       ; preds = %cond.false48, %cond.true46
  %cond50 = phi i64 [ %add47, %cond.true46 ], [ %mul, %cond.false48 ]
  store i64 %cond50, i64* %newsize, align 8
  %47 = load i64, i64* %newsize, align 8
  %48 = load i8*, i8** %read_pos, align 8
  %49 = load i8*, i8** %ptr, align 8
  %sub.ptr.lhs.cast51 = ptrtoint i8* %48 to i64
  %sub.ptr.rhs.cast52 = ptrtoint i8* %49 to i64
  %sub.ptr.sub53 = sub i64 %sub.ptr.lhs.cast51, %sub.ptr.rhs.cast52
  %sub54 = sub i64 %47, %sub.ptr.sub53
  %50 = load i64, i64* %buffer_len, align 8
  %add55 = add i64 %50, 1
  %cmp56 = icmp ult i64 %sub54, %add55
  br i1 %cmp56, label %if.then57, label %if.end63

if.then57:                                        ; preds = %cond.end49
  %51 = load i8*, i8** %read_pos, align 8
  %52 = load i8*, i8** %ptr, align 8
  %sub.ptr.lhs.cast58 = ptrtoint i8* %51 to i64
  %sub.ptr.rhs.cast59 = ptrtoint i8* %52 to i64
  %sub.ptr.sub60 = sub i64 %sub.ptr.lhs.cast58, %sub.ptr.rhs.cast59
  %53 = load i64, i64* %buffer_len, align 8
  %add61 = add i64 %sub.ptr.sub60, %53
  %add62 = add i64 %add61, 1
  store i64 %add62, i64* %newsize, align 8
  br label %if.end63

if.end63:                                         ; preds = %if.then57, %cond.end49
  %54 = load i64, i64* %size, align 8
  %55 = load i64, i64* %newsize, align 8
  %cmp64 = icmp ult i64 %54, %55
  br i1 %cmp64, label %land.lhs.true65, label %if.then67

land.lhs.true65:                                  ; preds = %if.end63
  %56 = load i64, i64* %newsize, align 8
  %57 = load i64, i64* %nmax.addr, align 8
  %cmp66 = icmp ule i64 %56, %57
  br i1 %cmp66, label %if.end68, label %if.then67

if.then67:                                        ; preds = %land.lhs.true65, %if.end63
  %58 = load i64, i64* %nmax.addr, align 8
  store i64 %58, i64* %newsize, align 8
  br label %if.end68

if.end68:                                         ; preds = %if.then67, %land.lhs.true65
  %59 = load i64, i64* %newsize, align 8
  %60 = load i64, i64* %offset.addr, align 8
  %sub69 = sub i64 %59, %60
  %cmp70 = icmp ult i64 9223372036854775807, %sub69
  br i1 %cmp70, label %if.then71, label %if.end77

if.then71:                                        ; preds = %if.end68
  %61 = load i64, i64* %offset.addr, align 8
  %add72 = add i64 %61, 9223372036854775807
  %add73 = add i64 %add72, 1
  store i64 %add73, i64* %newsizemax, align 8
  %62 = load i64, i64* %size, align 8
  %63 = load i64, i64* %newsizemax, align 8
  %cmp74 = icmp eq i64 %62, %63
...
if.end76:                                         ; preds = %if.then71
  %64 = load i64, i64* %newsizemax, align 8
  store i64 %64, i64* %newsize, align 8
  br label %if.end77

if.end77:                                         ; preds = %if.end76, %if.end68
  %65 = load i64, i64* %newsize, align 8
  %66 = load i8*, i8** %read_pos, align 8
  %67 = load i8*, i8** %ptr, align 8
  %sub.ptr.lhs.cast78 = ptrtoint i8* %66 to i64
  %sub.ptr.rhs.cast79 = ptrtoint i8* %67 to i64
  %sub.ptr.sub80 = sub i64 %sub.ptr.lhs.cast78, %sub.ptr.rhs.cast79
  %sub81 = sub i64 %65, %sub.ptr.sub80
  store i64 %sub81, i64* %nbytes_avail, align 8
  %68 = load i8*, i8** %ptr, align 8
  %69 = load i64, i64* %newsize, align 8
  %call82 = call i8* @realloc(i8* %68, i64 %69) #11
  store i8* %call82, i8** %newptr, align 8
  %70 = load i8*, i8** %newptr, align 8
  %tobool83 = icmp ne i8* %70, null
...
if.end85:                                         ; preds = %if.end77
  %71 = load i8*, i8** %newptr, align 8
  store i8* %71, i8** %ptr, align 8
  %72 = load i64, i64* %newsize, align 8
  store i64 %72, i64* %size, align 8
  %73 = load i64, i64* %size, align 8
  %74 = load i64, i64* %nbytes_avail, align 8
  %sub86 = sub i64 %73, %74
  %75 = load i8*, i8** %ptr, align 8
  %add.ptr87 = getelementptr inbounds i8, i8* %75, i64 %sub86
  store i8* %add.ptr87, i8** %read_pos, align 8
  br label %if.end88

if.end88:                                         ; preds = %if.end85, %land.lhs.true42, %if.end39
  %76 = load i64, i64* %nbytes_avail, align 8
  %cmp89 = icmp ult i64 1, %76
  br i1 %cmp89, label %if.then90, label %if.end101

if.then90:                                        ; preds = %if.end88
  %77 = load i64, i64* %nbytes_avail, align 8
  %sub91 = sub i64 %77, 1
  store i64 %sub91, i64* %copy_len, align 8
  %78 = load i64, i64* %buffer_len, align 8
  %79 = load i64, i64* %copy_len, align 8
  %cmp92 = icmp ult i64 %78, %79
  br i1 %cmp92, label %if.then93, label %if.end94

if.then93:                                        ; preds = %if.then90
  %80 = load i64, i64* %buffer_len, align 8
  store i64 %80, i64* %copy_len, align 8
  br label %if.end94
...
if.then96:                                        ; preds = %if.end94
  %82 = load i8*, i8** %read_pos, align 8
  %83 = load i8*, i8** %buffer, align 8
  %84 = load i64, i64* %copy_len, align 8
...
if.else97:                                        ; preds = %if.end94
  ...
  %86 = load i8*, i8** %read_pos, align 8
  store i8 %conv, i8* %86, align 1
  br label %if.end98

if.end98:                                         ; preds = %if.else97, %if.then96
  %87 = load i64, i64* %copy_len, align 8
  %88 = load i8*, i8** %read_pos, align 8
  %add.ptr99 = getelementptr inbounds i8, i8* %88, i64 %87
  store i8* %add.ptr99, i8** %read_pos, align 8
  %89 = load i64, i64* %copy_len, align 8
  %90 = load i64, i64* %nbytes_avail, align 8
  %sub100 = sub i64 %90, %89
  store i64 %sub100, i64* %nbytes_avail, align 8
  br label %if.end101

if.end101:                                        ; preds = %if.end98, %if.end88
  %91 = load i8*, i8** %buffer, align 8
  %tobool102 = icmp ne i8* %91, null
...
land.lhs.true103:                                 ; preds = %if.end101
  ...
  %93 = load i64, i64* %buffer_len, align 8
  %call104 = call i32 @freadseek(%struct._IO_FILE* %92, i64 %93)
...
do.cond:                                          ; preds = %if.end107
  %94 = load i8, i8* %found_delimiter, align 1
  %tobool108 = trunc i8 %94 to i1
  %lnot = xor i1 %tobool108, true
  br i1 %lnot, label %do.body, label %do.end

do.end:                                           ; preds = %do.cond, %if.else33
  %95 = load i8*, i8** %read_pos, align 8
  store i8 0, i8* %95, align 1
  %96 = load i8*, i8** %read_pos, align 8
  %97 = load i8*, i8** %ptr, align 8
  %98 = load i64, i64* %offset.addr, align 8
  %add.ptr109 = getelementptr inbounds i8, i8* %97, i64 %98
...
unlock_done:                                      ; preds = %do.end, %if.then106, %if.then84, %if.then75, %if.then32
  br label %done

done:                                             ; preds = %unlock_done, %if.then9, %if.then5
  %99 = load i8*, i8** %ptr, align 8
  %100 = load i8**, i8*** %lineptr.addr, align 8
  store i8* %99, i8** %100, align 8
  %101 = load i64, i64* %size, align 8
  %102 = load i64*, i64** %linesize.addr, align 8
...
cond.true114:                                     ; preds = %done
  %104 = load i64, i64* %bytes_stored, align 8
  br label %cond.end116

cond.false115:                                    ; preds = %done
  br label %cond.end116

cond.end116:                                      ; preds = %cond.false115, %cond.true114
  %cond117 = phi i64 [ %104, %cond.true114 ], [ -1, %cond.false115 ]
  store i64 %cond117, i64* %retval, align 8
  br label %return

return:                                           ; preds = %cond.end116, %if.then2
  %105 = load i64, i64* %retval, align 8
  ret i64 %105
}
...
if.end:                                           ; preds = %entry
  ...
  store i8* %7, i8** %void_ptr, align 8
  br label %for.cond
...
land.end:                                         ; preds = %land.rhs, %for.cond
  %11 = phi i1 [ false, %for.cond ], [ %cmp8, %land.rhs ]
  br i1 %11, label %for.body, label %for.end

for.body:                                         ; preds = %land.end
  %12 = load i8*, i8** %void_ptr, align 8
  store i8* %12, i8** %char_ptr, align 8
  %13 = load i8*, i8** %char_ptr, align 8
...
lor.lhs.false:                                    ; preds = %for.body
  %16 = load i8*, i8** %char_ptr, align 8
...
if.then18:                                        ; preds = %lor.lhs.false, %for.body
  %19 = load i8*, i8** %void_ptr, align 8
  store i8* %19, i8** %retval, align 8
  br label %return

if.end19:                                         ; preds = %lor.lhs.false
  %20 = load i8*, i8** %char_ptr, align 8
...
for.end:                                          ; preds = %land.end
  %22 = load i8*, i8** %void_ptr, align 8
  %23 = bitcast i8* %22 to i64*
  store i64* %23, i64** %longword_ptr, align 8
  ...
  %28 = load i64, i64* %repeated_c1, align 8
  %shl28 = shl i64 %28, 16
  %29 = load i64, i64* %repeated_c1, align 8
  %or29 = or i64 %29, %shl28
  store i64 %or29, i64* %repeated_c1, align 8
  %30 = load i64, i64* %repeated_c2, align 8
  %shl30 = shl i64 %30, 16
  %31 = load i64, i64* %repeated_c2, align 8
  %or31 = or i64 %31, %shl30
  store i64 %or31, i64* %repeated_c2, align 8
  %32 = load i64, i64* %repeated_one, align 8
  %shl32 = shl i64 %32, 31
  %shl33 = shl i64 %shl32, 1
  %33 = load i64, i64* %repeated_one, align 8
  %or34 = or i64 %33, %shl33
  store i64 %or34, i64* %repeated_one, align 8
  %34 = load i64, i64* %repeated_c1, align 8
  %shl35 = shl i64 %34, 31
  %shl36 = shl i64 %shl35, 1
  %35 = load i64, i64* %repeated_c1, align 8
  %or37 = or i64 %35, %shl36
  store i64 %or37, i64* %repeated_c1, align 8
  %36 = load i64, i64* %repeated_c2, align 8
  %shl38 = shl i64 %36, 31
  %shl39 = shl i64 %shl38, 1
  %37 = load i64, i64* %repeated_c2, align 8
  %or40 = or i64 %37, %shl39
  store i64 %or40, i64* %repeated_c2, align 8
  br label %while.cond

while.cond:                                       ; preds = %if.end53, %for.end
  %38 = load i64, i64* %n.addr, align 8
  %cmp41 = icmp uge i64 %38, 8
  br i1 %cmp41, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %39 = load i64*, i64** %longword_ptr, align 8
  %40 = load i64, i64* %39, align 8
  %41 = load i64, i64* %repeated_c1, align 8
  %xor = xor i64 %40, %41
  store i64 %xor, i64* %longword1, align 8
  %42 = load i64*, i64** %longword_ptr, align 8
  %43 = load i64, i64* %42, align 8
  %44 = load i64, i64* %repeated_c2, align 8
  %xor43 = xor i64 %43, %44
  store i64 %xor43, i64* %longword2, align 8
  %45 = load i64, i64* %longword1, align 8
  %46 = load i64, i64* %repeated_one, align 8
  %sub = sub i64 %45, %46
  %47 = load i64, i64* %longword1, align 8
  %neg = xor i64 %47, -1
  %and = and i64 %sub, %neg
  %48 = load i64, i64* %longword2, align 8
  %49 = load i64, i64* %repeated_one, align 8
  %sub44 = sub i64 %48, %49
  %50 = load i64, i64* %longword2, align 8
  %neg45 = xor i64 %50, -1
  %and46 = and i64 %sub44, %neg45
  %or47 = or i64 %and, %and46
  %51 = load i64, i64* %repeated_one, align 8
  %shl48 = shl i64 %51, 7
...
while.end:                                        ; preds = %if.then52, %while.cond
  %54 = load i64*, i64** %longword_ptr, align 8
  %55 = bitcast i64* %54 to i8*
  store i8* %55, i8** %char_ptr, align 8
  br label %for.cond55
...
for.body58:                                       ; preds = %for.cond55
  %57 = load i8*, i8** %char_ptr, align 8
...
lor.lhs.false63:                                  ; preds = %for.body58
  %60 = load i8*, i8** %char_ptr, align 8
...
for.inc70:                                        ; preds = %if.end69
  ...
  %65 = load i8*, i8** %char_ptr, align 8
...
cond.end33:                                       ; preds = %cond.false32, %cond.true31
  %cond34 = phi i64 [ 4096, %cond.true31 ], [ %27, %cond.false32 ]
...
if.then:                                          ; preds = %entry
  store i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.185, i64 0, i64 0), i8** %codeset, align 8
  br label %if.end
...
if.then3:                                         ; preds = %if.end
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1.186, i64 0, i64 0), i8** %codeset, align 8
  br label %if.end4
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i64 [ %sub.ptr.sub3, %cond.true ], [ 0, %cond.false ]
