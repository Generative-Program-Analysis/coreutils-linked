...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i8** [ %arrayidx11, %cond.true ], [ null, %cond.false ]
...
while.cond1:                                      ; preds = %while.body5, %do.body
...
land.end:                                         ; preds = %land.rhs, %while.cond1
  %3 = phi i1 [ false, %while.cond1 ], [ %tobool4, %land.rhs ]
  br i1 %3, label %while.body5, label %while.end

while.body5:                                      ; preds = %land.end
  br label %while.cond1

while.end:                                        ; preds = %land.end
  %4 = load i8, i8* %convert, align 1
...
if.then9:                                         ; preds = %if.then7
  %6 = load i64, i64* %column, align 8
  %call10 = call i64 @get_next_tab_column(i64 %6, i64* %tab_index, i8* %last_tab)
  store i64 %call10, i64* %next_tab_column, align 8
  %7 = load i8, i8* %last_tab, align 1
  %tobool11 = trunc i8 %7 to i1
  br i1 %tobool11, label %if.then12, label %if.end13

if.then12:                                        ; preds = %if.then9
  %8 = load i64, i64* %column, align 8
  %add = add i64 %8, 1
  store i64 %add, i64* %next_tab_column, align 8
  br label %if.end13

if.end13:                                         ; preds = %if.then12, %if.then9
  %9 = load i64, i64* %next_tab_column, align 8
  %10 = load i64, i64* %column, align 8
  %cmp14 = icmp ult i64 %9, %10
...
while.cond17:                                     ; preds = %if.end24, %if.end16
  ...
  %12 = load i64, i64* %next_tab_column, align 8
  %cmp18 = icmp ult i64 %inc, %12
...
if.then22:                                        ; preds = %while.body19
  ...
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %13, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.33, i64 0, i64 0))
  unreachable
...
if.end43:                                         ; preds = %if.end42, %while.end25
  %21 = load i8, i8* @convert_entire_line, align 1
...
lor.rhs:                                          ; preds = %if.end43
  ...
  %22 = load i16*, i16** %call46, align 8
...
lor.end:                                          ; preds = %lor.rhs, %if.end43
  %25 = phi i1 [ true, %if.end43 ], [ %lnot51, %lor.rhs ]
  %lor.ext = zext i1 %25 to i32
  %26 = load i8, i8* %convert, align 1
...
if.end61:                                         ; preds = %if.end57
  ...
  %call62 = call i32 @putchar_unlocked(i32 %28)
  %cmp63 = icmp slt i32 %call62, 0
  br i1 %cmp63, label %if.then65, label %if.end67

if.then65:                                        ; preds = %if.end61
  %call66 = call i32* @__errno_location() #15
  %29 = load i32, i32* %call66, align 4
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %29, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.33, i64 0, i64 0))
  unreachable
...
do.cond:                                          ; preds = %if.end67
  ...
  %cmp68 = icmp ne i32 %30, 10
  br i1 %cmp68, label %do.body, label %do.end

do.end:                                           ; preds = %do.cond
  br label %while.body

return:                                           ; preds = %if.then60, %if.then
  ret void
}
...
cond.end4:                                        ; preds = %cond.false3, %cond.true1
  %cond5 = phi i64 [ %sub2, %cond.true1 ], [ 0, %cond.false3 ]
...
if.else17:                                        ; preds = %if.else
  %13 = load i64, i64* %tabval, align 8
  call void @add_tab_stop(i64 %13)
  br label %if.end18
...
if.else21:                                        ; preds = %lor.lhs.false
  %14 = load i8*, i8** %stops.addr, align 8
...
if.else30:                                        ; preds = %if.else21
  %18 = load i8*, i8** %stops.addr, align 8
...
if.else39:                                        ; preds = %if.else30
  %22 = load i8*, i8** %stops.addr, align 8
...
if.then43:                                        ; preds = %if.else39
  %24 = load i8, i8* %have_tabval, align 1
...
if.then45:                                        ; preds = %if.then43
  ...
  %25 = load i8*, i8** %stops.addr, align 8
  store i8* %25, i8** %num_start, align 8
  br label %if.end46
...
if.end46:                                         ; preds = %if.then45, %if.then43
  ...
  %cmp49 = icmp ult i64 1844674407370955161, %26
  br i1 %cmp49, label %cond.true, label %lor.lhs.false51

lor.lhs.false51:                                  ; preds = %if.end46
  %27 = load i64, i64* %tabval, align 8
  %mul = mul i64 %27, 10
  %28 = load i8*, i8** %stops.addr, align 8
  ...
  %cmp55 = icmp ult i64 %add, %30
  br i1 %cmp55, label %cond.true, label %cond.false

cond.true:                                        ; preds = %lor.lhs.false51, %if.end46
  br label %cond.end

cond.false:                                       ; preds = %lor.lhs.false51
  %31 = load i64, i64* %tabval, align 8
  %mul57 = mul i64 %31, 10
  %32 = load i8*, i8** %stops.addr, align 8
...
if.end68:                                         ; preds = %if.then63, %cond.end
  br label %if.end71

if.else69:                                        ; preds = %if.else39
  %41 = load i8*, i8** %stops.addr, align 8
  %call70 = call i8* @quote(i8* %41)
...
if.end73:                                         ; preds = %if.end72, %if.end29
  br label %if.end74
...
for.inc:                                          ; preds = %if.end74
  %42 = load i8*, i8** %stops.addr, align 8
...
land.lhs.true:                                    ; preds = %for.end
  %44 = load i8, i8* %have_tabval, align 1
  %tobool77 = trunc i8 %44 to i1
  br i1 %tobool77, label %if.then79, label %if.end101

if.then79:                                        ; preds = %land.lhs.true
  %45 = load i8, i8* %extend_tabval, align 1
  %tobool80 = trunc i8 %45 to i1
  br i1 %tobool80, label %if.then81, label %if.else88

if.then81:                                        ; preds = %if.then79
  %46 = load i64, i64* %tabval, align 8
  %call82 = call zeroext i1 @set_extend_size(i64 %46)
  %conv83 = zext i1 %call82 to i32
  %47 = load i8, i8* %ok, align 1
  %tobool84 = trunc i8 %47 to i1
...
if.else88:                                        ; preds = %if.then79
  %48 = load i8, i8* %increment_tabval, align 1
  %tobool89 = trunc i8 %48 to i1
  br i1 %tobool89, label %if.then90, label %if.else98

if.then90:                                        ; preds = %if.else88
  %49 = load i64, i64* %tabval, align 8
  %call91 = call zeroext i1 @set_increment_size(i64 %49)
...
if.else98:                                        ; preds = %if.else88
  %51 = load i64, i64* %tabval, align 8
  call void @add_tab_stop(i64 %51)
  br label %if.end99

if.end99:                                         ; preds = %if.else98, %if.then90
  br label %if.end100

if.end100:                                        ; preds = %if.end99, %if.then81
  br label %if.end101

if.end101:                                        ; preds = %if.end100, %land.lhs.true, %for.end
  %52 = load i8, i8* %ok, align 1
  %tobool102 = trunc i8 %52 to i1
...
cond.end:                                         ; preds = %cond.false3, %cond.true2
  %cond = phi i64 [ %6, %cond.true2 ], [ 8, %cond.false3 ]
  br label %cond.end4

cond.end4:                                        ; preds = %cond.end, %cond.true
  %cond5 = phi i64 [ %4, %cond.true ], [ %cond, %cond.end ]
...
if.else11:                                        ; preds = %land.lhs.true8, %land.lhs.true, %if.else
...
if.end12:                                         ; preds = %if.end, %cond.end4
  ret void
}
...
if.end9:                                          ; preds = %land.lhs.true, %for.end
  ret void
}
...
if.else10:                                        ; preds = %if.end7
  ...
  %call11 = call i32 @rpl_fclose(%struct._IO_FILE* %7)
...
if.then13:                                        ; preds = %if.else10
  ...
  %9 = load i8*, i8** @next_file.prev_file, align 8
  %call15 = call i8* @quotearg_n_style_colon(i32 0, i32 3, i8* %9)
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %8, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8.58, i64 0, i64 0), i8* %call15)
  store i32 1, i32* @exit_status, align 4
  br label %if.end16
...
while.cond:                                       ; preds = %if.end28, %if.end18
  %10 = load i8**, i8*** @file_list, align 8
...
while.body:                                       ; preds = %while.cond
  ...
  %call20 = call i32 @strcmp(i8* %12, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9.53, i64 0, i64 0)) #13
...
if.then22:                                        ; preds = %while.body
  ...
  store %struct._IO_FILE* %13, %struct._IO_FILE** %fp.addr, align 8
  br label %if.end25

if.else23:                                        ; preds = %while.body
  %14 = load i8*, i8** %file, align 8
  %call24 = call %struct._IO_FILE* @fopen(i8* %14, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10.59, i64 0, i64 0))
...
if.end25:                                         ; preds = %if.else23, %if.then22
  ...
  %tobool26 = icmp ne %struct._IO_FILE* %15, null
  br i1 %tobool26, label %if.then27, label %if.end28

if.then27:                                        ; preds = %if.end25
  %16 = load i8*, i8** %file, align 8
  store i8* %16, i8** @next_file.prev_file, align 8
  %17 = load %struct._IO_FILE*, %struct._IO_FILE** %fp.addr, align 8
  call void @fadvise(%struct._IO_FILE* %17, i32 2)
  %18 = load %struct._IO_FILE*, %struct._IO_FILE** %fp.addr, align 8
  store %struct._IO_FILE* %18, %struct._IO_FILE** %retval, align 8
  br label %return
...
if.end28:                                         ; preds = %if.end25
  ...
  %call30 = call i8* @quotearg_n_style_colon(i32 0, i32 3, i8* %20)
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %19, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8.58, i64 0, i64 0), i8* %call30)
  store i32 1, i32* @exit_status, align 4
  br label %while.cond
...
return:                                           ; preds = %while.end, %if.then27
  %21 = load %struct._IO_FILE*, %struct._IO_FILE** %retval, align 8
...
if.else:                                          ; preds = %if.then
  ...
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %7, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2.73, i64 0, i64 0), i8* %8)
  br label %if.end
...
if.else:                                          ; preds = %entry
  ...
  %call1 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1.111, i64 0, i64 0), i8* %6, i8* %7)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %8, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @version_etc_copyright, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2.112, i64 0, i64 0), i32 2020)
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call3 = call i32 @fputs_unlocked(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3.113, i64 0, i64 0), %struct._IO_FILE* %9)
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call4 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %10, i8* getelementptr inbounds ([171 x i8], [171 x i8]* @.str.4.114, i64 0, i64 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.5.115, i64 0, i64 0))
  %11 = load %struct._IO_FILE*, %struct._IO_FILE** %stream.addr, align 8
  %call5 = call i32 @fputs_unlocked(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3.113, i64 0, i64 0), %struct._IO_FILE* %11)
...
sw.bb6:                                           ; preds = %if.end
  ...
  %call7 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %13, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.6.116, i64 0, i64 0), i8* %15)
  br label %sw.epilog
...
sw.bb8:                                           ; preds = %if.end
  ...
  %call11 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %16, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7.117, i64 0, i64 0), i8* %18, i8* %20)
  br label %sw.epilog
...
sw.bb12:                                          ; preds = %if.end
  ...
  %call16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %21, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.8.118, i64 0, i64 0), i8* %23, i8* %25, i8* %27)
  br label %sw.epilog
...
sw.bb17:                                          ; preds = %if.end
  ...
  %call22 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %28, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.9.119, i64 0, i64 0), i8* %30, i8* %32, i8* %34, i8* %36)
  br label %sw.epilog
...
sw.bb23:                                          ; preds = %if.end
  ...
  %call29 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %37, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.10.120, i64 0, i64 0), i8* %39, i8* %41, i8* %43, i8* %45, i8* %47)
  br label %sw.epilog
...
sw.bb30:                                          ; preds = %if.end
  ...
  %call37 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.11.121, i64 0, i64 0), i8* %50, i8* %52, i8* %54, i8* %56, i8* %58, i8* %60)
  br label %sw.epilog
...
sw.bb38:                                          ; preds = %if.end
  ...
  %call46 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %61, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.12.122, i64 0, i64 0), i8* %63, i8* %65, i8* %67, i8* %69, i8* %71, i8* %73, i8* %75)
  br label %sw.epilog
...
sw.bb47:                                          ; preds = %if.end
  ...
  %call56 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %76, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.13.123, i64 0, i64 0), i8* %78, i8* %80, i8* %82, i8* %84, i8* %86, i8* %88, i8* %90, i8* %92)
  br label %sw.epilog
...
sw.bb57:                                          ; preds = %if.end
  ...
  %call67 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %93, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.14.124, i64 0, i64 0), i8* %95, i8* %97, i8* %99, i8* %101, i8* %103, i8* %105, i8* %107, i8* %109, i8* %111)
  br label %sw.epilog
...
sw.default:                                       ; preds = %if.end
  ...
  %call77 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %112, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.15.125, i64 0, i64 0), i8* %114, i8* %116, i8* %118, i8* %120, i8* %122, i8* %124, i8* %126, i8* %128, i8* %130)
  br label %sw.epilog
...
if.then:                                          ; preds = %entry
  store i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.169, i64 0, i64 0), i8** %codeset, align 8
  br label %if.end
...
if.then3:                                         ; preds = %if.end
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1.170, i64 0, i64 0), i8** %codeset, align 8
  br label %if.end4
