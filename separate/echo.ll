...
lor.end:                                          ; preds = %land.end, %entry
  ...
  %8 = load i8, i8* %allow_options, align 1
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %call11 = call i32 @strcmp(i8* %11, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.15, i64 0, i64 0)) #13
...
if.end:                                           ; preds = %if.then
  ...
  %call15 = call i32 @strcmp(i8* %13, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.16, i64 0, i64 0)) #13
...
if.end19:                                         ; preds = %if.end18, %land.lhs.true, %lor.end
  ...
  %18 = load i8, i8* %allow_options, align 1
...
while.cond:                                       ; preds = %while.end, %if.then21
...
land.end27:                                       ; preds = %land.rhs23, %while.cond
  %23 = phi i1 [ false, %while.cond ], [ %cmp25, %land.rhs23 ]
  br i1 %23, label %while.body, label %while.end48

while.body:                                       ; preds = %land.end27
  %24 = load i8**, i8*** %argv.addr, align 8
  %arrayidx28 = getelementptr inbounds i8*, i8** %24, i64 0
...
for.cond:                                         ; preds = %for.inc, %while.body
  ...
  %arrayidx29 = getelementptr inbounds i8, i8* %26, i64 %27
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx31 = getelementptr inbounds i8, i8* %29, i64 %30
...
while.cond37:                                     ; preds = %sw.epilog45, %if.end36
...
while.body39:                                     ; preds = %while.cond37
  ...
  switch i32 %conv41, label %sw.epilog45 [
    i32 101, label %sw.bb42
    i32 69, label %sw.bb43
    i32 110, label %sw.bb44
  ]

sw.bb42:                                          ; preds = %while.body39
  store i8 1, i8* %do_v9, align 1
  br label %sw.epilog45

sw.bb43:                                          ; preds = %while.body39
  store i8 0, i8* %do_v9, align 1
  br label %sw.epilog45

sw.bb44:                                          ; preds = %while.body39
  store i8 0, i8* %display_return, align 1
  br label %sw.epilog45

sw.epilog45:                                      ; preds = %while.body39, %sw.bb44, %sw.bb43, %sw.bb42
  br label %while.cond37
...
if.end49:                                         ; preds = %while.end48, %if.end19
  br label %just_echo

just_echo:                                        ; preds = %if.end49, %if.then35, %sw.default
  %40 = load i8, i8* %do_v9, align 1
  %tobool50 = trunc i8 %40 to i1
  br i1 %tobool50, label %if.then54, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %just_echo
  %41 = load i8, i8* %posixly_correct, align 1
  %tobool52 = trunc i8 %41 to i1
  br i1 %tobool52, label %if.then54, label %if.else
...
while.cond55:                                     ; preds = %if.end166, %if.then54
  ...
  br i1 %cmp56, label %while.body58, label %while.end167

while.body58:                                     ; preds = %while.cond55
  %43 = load i8**, i8*** %argv.addr, align 8
  %arrayidx59 = getelementptr inbounds i8*, i8** %43, i64 0
...
if.then70:                                        ; preds = %land.lhs.true67
  ...
  switch i32 %conv72, label %sw.default153 [
    ...
    i32 118, label %sw.bb81
    i32 120, label %sw.bb82
    i32 48, label %sw.bb106
    i32 49, label %sw.bb117
    i32 50, label %sw.bb117
    i32 51, label %sw.bb117
    i32 52, label %sw.bb117
    i32 53, label %sw.bb117
    i32 54, label %sw.bb117
    i32 55, label %sw.bb117
    i32 92, label %sw.bb152
  ]
...
sw.bb76:                                          ; preds = %if.then70
  store i8 27, i8* %c, align 1
  br label %sw.epilog155

sw.bb77:                                          ; preds = %if.then70
...
sw.bb80:                                          ; preds = %if.then70
  store i8 9, i8* %c, align 1
  br label %sw.epilog155

sw.bb81:                                          ; preds = %if.then70
...
sw.bb82:                                          ; preds = %if.then70
  ...
  store i8 %53, i8* %ch, align 1
  %call83 = call i16** @__ctype_b_loc() #15
  %54 = load i16*, i16** %call83, align 8
  %55 = load i8, i8* %ch, align 1
  %conv84 = zext i8 %55 to i32
  %idxprom = sext i32 %conv84 to i64
  %arrayidx85 = getelementptr inbounds i16, i16* %54, i64 %idxprom
...
if.then88:                                        ; preds = %sw.bb82
  br label %not_an_escape

if.end89:                                         ; preds = %sw.bb82
  %57 = load i8*, i8** %s, align 8
  %incdec.ptr90 = getelementptr inbounds i8, i8* %57, i32 1
  store i8* %incdec.ptr90, i8** %s, align 8
  %58 = load i8, i8* %ch, align 1
  %call91 = call i32 @hextobin(i8 zeroext %58)
  ...
  %61 = load i16*, i16** %call93, align 8
  %62 = load i8, i8* %ch, align 1
  %conv94 = zext i8 %62 to i32
  %idxprom95 = sext i32 %conv94 to i64
  %arrayidx96 = getelementptr inbounds i16, i16* %61, i64 %idxprom95
  %63 = load i16, i16* %arrayidx96, align 2
  %conv97 = zext i16 %63 to i32
...
if.then100:                                       ; preds = %if.end89
  ...
  %incdec.ptr101 = getelementptr inbounds i8, i8* %64, i32 1
...
if.then114:                                       ; preds = %land.lhs.true110, %sw.bb106
  br label %sw.epilog155
...
sw.bb117:                                         ; preds = %if.then70, %if.then70, %if.then70, %if.then70, %if.then70, %if.then70, %if.then70, %if.end115
...
if.then127:                                       ; preds = %land.lhs.true123
  ...
  %incdec.ptr130 = getelementptr inbounds i8, i8* %79, i32 1
...
if.end135:                                        ; preds = %if.then127, %land.lhs.true123, %sw.bb117
  ...
  br i1 %cmp137, label %land.lhs.true139, label %if.end151
...
if.end151:                                        ; preds = %if.then143, %land.lhs.true139, %if.end135
  br label %sw.epilog155

sw.bb152:                                         ; preds = %if.then70
  br label %sw.epilog155

not_an_escape:                                    ; preds = %if.then88
  br label %sw.default153

sw.default153:                                    ; preds = %if.then70, %not_an_escape
  %call154 = call i32 @putchar_unlocked(i32 92)
  br label %sw.epilog155

sw.epilog155:                                     ; preds = %sw.default153, %sw.bb152, %if.end151, %if.then114, %if.end105, %sw.bb81, %sw.bb80, %sw.bb79, %sw.bb78, %sw.bb77, %sw.bb76, %sw.bb74, %sw.bb73
  br label %if.end156

if.end156:                                        ; preds = %sw.epilog155, %land.lhs.true67, %while.body63
...
while.end167:                                     ; preds = %while.cond55
  br label %if.end182

if.else:                                          ; preds = %lor.lhs.false
  br label %while.cond168

while.cond168:                                    ; preds = %if.end180, %if.else
  %92 = load i32, i32* %argc.addr, align 4
  %cmp169 = icmp sgt i32 %92, 0
  br i1 %cmp169, label %while.body171, label %while.end181

while.body171:                                    ; preds = %while.cond168
  %93 = load i8**, i8*** %argv.addr, align 8
  %arrayidx172 = getelementptr inbounds i8*, i8** %93, i64 0
  %94 = load i8*, i8** %arrayidx172, align 8
  %95 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call173 = call i32 @fputs_unlocked(i8* %94, %struct._IO_FILE* %95)
  %96 = load i32, i32* %argc.addr, align 4
  %dec174 = add nsw i32 %96, -1
  store i32 %dec174, i32* %argc.addr, align 4
  %97 = load i8**, i8*** %argv.addr, align 8
  %incdec.ptr175 = getelementptr inbounds i8*, i8** %97, i32 1
  store i8** %incdec.ptr175, i8*** %argv.addr, align 8
  %98 = load i32, i32* %argc.addr, align 4
  %cmp176 = icmp sgt i32 %98, 0
...
while.end181:                                     ; preds = %while.cond168
  br label %if.end182

if.end182:                                        ; preds = %while.end181, %while.end167
  %99 = load i8, i8* %display_return, align 1
  %tobool183 = trunc i8 %99 to i1
...
if.else:                                          ; preds = %if.then
  ...
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %7, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2.41, i64 0, i64 0), i8* %8)
  br label %if.end
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %8, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @version_etc_copyright, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2.74, i64 0, i64 0), i32 2020)
...
sw.bb6:                                           ; preds = %if.end
  ...
  %call7 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %13, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.6.78, i64 0, i64 0), i8* %15)
  br label %sw.epilog
...
sw.bb8:                                           ; preds = %if.end
  ...
  %call11 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %16, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7.79, i64 0, i64 0), i8* %18, i8* %20)
  br label %sw.epilog
...
sw.bb12:                                          ; preds = %if.end
  ...
  %call16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %21, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.8.80, i64 0, i64 0), i8* %23, i8* %25, i8* %27)
  br label %sw.epilog
...
sw.bb17:                                          ; preds = %if.end
  ...
  %call22 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %28, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.9.81, i64 0, i64 0), i8* %30, i8* %32, i8* %34, i8* %36)
  br label %sw.epilog
...
sw.bb23:                                          ; preds = %if.end
  ...
  %call29 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %37, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.10.82, i64 0, i64 0), i8* %39, i8* %41, i8* %43, i8* %45, i8* %47)
  br label %sw.epilog
...
sw.bb30:                                          ; preds = %if.end
  ...
  %call37 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %48, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.11.83, i64 0, i64 0), i8* %50, i8* %52, i8* %54, i8* %56, i8* %58, i8* %60)
  br label %sw.epilog
...
sw.bb38:                                          ; preds = %if.end
  ...
  %call46 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %61, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.12.84, i64 0, i64 0), i8* %63, i8* %65, i8* %67, i8* %69, i8* %71, i8* %73, i8* %75)
  br label %sw.epilog
...
sw.bb47:                                          ; preds = %if.end
  ...
  %call56 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %76, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.13.85, i64 0, i64 0), i8* %78, i8* %80, i8* %82, i8* %84, i8* %86, i8* %88, i8* %90, i8* %92)
  br label %sw.epilog
...
sw.bb57:                                          ; preds = %if.end
  ...
  %call67 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %93, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.14.86, i64 0, i64 0), i8* %95, i8* %97, i8* %99, i8* %101, i8* %103, i8* %105, i8* %107, i8* %109, i8* %111)
  br label %sw.epilog
...
sw.default:                                       ; preds = %if.end
  ...
  %call77 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %112, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.15.87, i64 0, i64 0), i8* %114, i8* %116, i8* %118, i8* %120, i8* %122, i8* %124, i8* %126, i8* %128, i8* %130)
  br label %sw.epilog
...
declare dso_local i32 @c_tolower(i32) #2
...
if.then:                                          ; preds = %entry
  store i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.121, i64 0, i64 0), i8** %codeset, align 8
  br label %if.end
...
if.then3:                                         ; preds = %if.end
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1.122, i64 0, i64 0), i8** %codeset, align 8
  br label %if.end4
